...
namespace CefNet
{
	public class VirtualDevice
	{
		...
		public CefScreenInfo ScreenInfo => _screenInfo;

		public float DevicePixelRatio => _screenInfo.DeviceScaleFactor;
		...
		public virtual CefRect ViewportRect => _screenInfo.AvailableRect;

		public virtual void Rotate()
		{
			var screenRect = _screenInfo.Rect;
			var screenAvail = _screenInfo.AvailableRect;
			_screenInfo.Rect = new CefRect(screenRect.Y, screenRect.X, screenRect.Height, screenRect.Width);
			_screenInfo.AvailableRect =
				new CefRect(screenAvail.Y, screenAvail.X, screenAvail.Height, screenAvail.Width);
		}
