...
namespace CefNet
{
	...
	{
		private static readonly Dictionary<HashKey, WeakReference<CefV8Value>> WeakRefs =
			new Dictionary<HashKey, WeakReference<CefV8Value>>(new HashKeyComparer());
		...
		public CefV8Value(CefV8Accessor accessor, CefV8Interceptor interceptor)
			: this(CefNativeApi.cef_v8value_create_object(accessor != null ? accessor.GetNativeInstance() : null,
				interceptor != null ? interceptor.GetNativeInstance() : null))
		{
		}
		...
		public CefV8ValueType Type
		{
			get
			{
				...
				{
					var ws = RefCountedWrapperStruct.FromRefCounted(NativeInstance);
		...
		{
			var t = CefTime.FromDateTime(date);
		...
		///  provided <paramref name="buffer" /> of size <paramref name="length" /> bytes.
		///  <para />
		///  This function should only be called from within the scope of a
		///  <see cref="CefRenderProcessHandler" />, <see cref="CefV8Handler" /> or
		///  <see cref="CefV8Accessor" /> callback, or in combination with calling
		...
		public static CefV8Value CreateArrayBuffer(void* buffer, int length, CefV8ArrayBufferReleaseCallback callback)
		{
			...
			return new CefV8Value(
				CefNativeApi.cef_v8value_create_array_buffer(buffer, (UIntPtr) length, callback.GetNativeInstance()));
		}

		/// <summary>
		///  Create a new <see cref="CefV8Value" /> object of type ArrayBuffer which wraps the
		///  provided <paramref name="buffer" />.
		///  <para />
		///  This function should only be called from within the scope of a
		///  <see cref="CefRenderProcessHandler" />, <see cref="CefV8Handler" /> or
		///  <see cref="CefV8Accessor" /> callback, or in combination with calling
		...
		public static CefV8Value CreateArrayBuffer(byte[] buffer)
		{
			...
			return new CefV8Value(CefNativeApi.cef_v8value_create_array_buffer(instance.GetBuffer(), instance.Length,
				instance.GetNativeInstance()));
		}

		/// <summary>
		///  Create a new <see cref="CefV8Value" /> object of type function.
		///  <para />
		///  This function should only be called from within the scope of a
		///  <see cref="CefRenderProcessHandler" />, <see cref="CefV8Handler" /> or
		///  <see cref="CefV8Accessor" /> callback, or in combination with calling
		...
		{
			using (var str = new CefV8Value(value))
			{
		...
		public bool CopyV8StringToCefValue(CefValue value)
		{
			...
			var userfreeStr = NativeInstance->GetStringValue();
			try
			{
		...
		/// <summary>
		///  Execute the function without arguments using the current V8 context.
		///  <para />
		...
		/// </returns>
		public virtual CefV8Value ExecuteFunction(CefV8Value thisArg)
		{
			return SafeCall(Wrap(Create,
				NativeInstance->ExecuteFunction(thisArg != null ? thisArg.GetNativeInstance() : null, new UIntPtr(),
					null)));
		}
		...
		public void SetValue(string[] names, CefV8Value value, CefV8PropertyAttribute attribute)
		{
			...
			var self = this;
			if (last > 0) self = GetValue(new ArraySegment<string>(names, 0, last));
...
#pragma warning restore CS1591
		...
		public static CefV8Value Wrap(Func<IntPtr, CefV8Value> create, cef_v8value_t* instance)
		{
			if (instance == null)
				return null;

			var ptr = new IntPtr(instance);
			lock (WeakRefs)
			{
				CefV8Value wrapper;
				var hashcode = instance->GetHashCode();

				if (WeakRefs.TryGetValue(new HashKey(hashcode, instance), out var weakRef)
