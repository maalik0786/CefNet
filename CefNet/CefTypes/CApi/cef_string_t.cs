...
namespace CefNet.CApi
{
	...
	public unsafe partial struct cef_string_t
	{
		...
		public int CompareOrdinal(string s)
		{
		...
		/// <returns>A 32-bit signed integer that indicates the lexical relationship between the two comparands.</returns>
		public static int CompareOrdinal(cef_string_t* a, string b)
		{
			...
			if (*a->Str - b[0] != 0) return *a->Str - b[0];
			return IntPtr.Size == 8 ? CompareOrdinalHelper64(a, b) : CompareOrdinalHelper32(a, b);
		}

		private static int CompareOrdinalHelper32(cef_string_t* strA, string strB)
		{
		...
		private static int CompareOrdinalHelper64(cef_string_t* strA, string strB)
		{
