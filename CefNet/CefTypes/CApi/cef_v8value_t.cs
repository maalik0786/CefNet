...
#pragma warning restore CS1591
	{
		...
		public override int GetHashCode()
		{
			...
			{
				var ws = RefCountedWrapperStruct.FromRefCounted(self);
				var cppobj = (V8ValueImplLayout*) ws->cppObject;
				switch (cppobj->Type)
				{
					case CefV8ValueType.Object:
						var v8ValueHandle = cppobj->handle;
						if (v8ValueHandle == null)
							return 0;
						var handle = v8ValueHandle->handle;
