...
namespace CefNet.CApi
{
	...
	public static partial class CefNativeApi
	{
		...
		/// </remarks>
		[DllImport("libcef", EntryPoint = "cef_get_current_platform_thread_handle",
			CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr cef_get_current_platform_thread_handle_linux();
		...
		[DllImport("libcef", EntryPoint = "cef_get_current_platform_thread_handle",
			CallingConvention = CallingConvention.Cdecl)]
		public static extern uint cef_get_current_platform_thread_handle_windows();
	}
}