...
namespace CefNet.CApi
{
	...
	public struct cef_window_info_windows_t
	{
		...
		///  <para />
		///  Standard parameter required by
		///  <see href="https://docs.microsoft.com/windows/win32/api/winuser/nf-winuser-createwindowexw">CreateWindowEx()</see>.
		...
		///  See
		///  <see href="https://docs.microsoft.com/windows/win32/api/winuser/nf-winuser-createwindowexw">Microsoft Docs</see>
		...
		///  rendering.
		///  <para />
		///  No window will be created for the browser and all rendering will
		...
		///  valid if <see cref="windowless_rendering_enabled" /> above is also set to true.
		///  <para />
	...
	public struct cef_window_info_mac_t
	{
		...
		///  rendering.
		///  <para />
		///  No view will be created for the browser and all rendering will
