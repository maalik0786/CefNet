...
namespace CefNet
{
	...
	{
		private static readonly HashSet<WeakReference<CefV8Context>> WeakRefs =
			new HashSet<WeakReference<CefV8Context>>();
		...
		/// </summary>
		public static bool InContext => CefNativeApi.cef_v8context_in_context() != 0;
		...
		{
			return Wrap(Create, CefNativeApi.cef_v8context_get_current_context());
		}
		...
		{
			return Wrap(Create, CefNativeApi.cef_v8context_get_entered_context());
		}

		public static CefV8Context Wrap(Func<IntPtr, CefV8Context> create, cef_v8context_t* instance)
		{
			if (instance == null)
				return null;
