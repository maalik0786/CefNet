...
namespace CefNet
{
	public partial struct CefCompositionUnderline
	{
		/// <summary>
		...
		public CefCompositionUnderline(CefRange range, CefColor color, CefColor backgroundColor, bool thick)
		{
			...
			{
				range = range, color = color, background_color = backgroundColor, thick = thick ? 1 : 0
			};
		}
		...
		public CefCompositionUnderline(CefRange range, CefColor color, CefColor backgroundColor, bool thick,
			CefCompositionUnderlineStyle style)
		{
			_instance = new cef_composition_underline_t
			{
				range = range,
