...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefLifeSpanHandler : CefBaseRefCounted<cef_life_span_handler_t>, ICefLifeSpanHandlerPrivate
	{
		...
		internal static CefLifeSpanHandler Create(IntPtr instance)
		{
		...
		private static int OnBeforePopupImpl(cef_life_span_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
			...
			cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* no_javascript_access)
		{
			...
			var obj_extra_info = CefDictionaryValue.Wrap(CefDictionaryValue.Create, *extra_info);
			var rv = instance.OnBeforePopup(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefString.Read(target_url), CefString.Read(target_frame_name),
				target_disposition, user_gesture != 0, *(CefPopupFeatures*) popupFeatures,
				CefWindowInfo.Wrap(windowInfo), ref obj_client, new CefBrowserSettings(settings), ref obj_extra_info,
		...
		private static void OnAfterCreatedImpl(cef_life_span_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefLifeSpanHandler;
		...
		private static int DoCloseImpl(cef_life_span_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefLifeSpanHandler;
		...
		// void (*)(_cef_life_span_handler_t* self, _cef_browser_t* browser)*
		private static void OnBeforeCloseImpl(cef_life_span_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefLifeSpanHandler;
		...
		private delegate int OnBeforePopupDelegate(cef_life_span_handler_t* self, cef_browser_t* browser,
		...
		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnAfterCreatedDelegate(cef_life_span_handler_t* self, cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int DoCloseDelegate(cef_life_span_handler_t* self, cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnBeforeCloseDelegate(cef_life_span_handler_t* self, cef_browser_t* browser);
	}
}