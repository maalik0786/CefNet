...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefFocusHandler : CefBaseRefCounted<cef_focus_handler_t>, ICefFocusHandlerPrivate
	{
		...
		internal static CefFocusHandler Create(IntPtr instance)
		{
		...
		private static void OnTakeFocusImpl(cef_focus_handler_t* self, cef_browser_t* browser, int next)
		{
		...
		private static int OnSetFocusImpl(cef_focus_handler_t* self, cef_browser_t* browser, CefFocusSource source)
		{
			var instance = GetInstance((IntPtr) self) as CefFocusHandler;
		...
		private static void OnGotFocusImpl(cef_focus_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefFocusHandler;
		...
		private delegate void OnTakeFocusDelegate(cef_focus_handler_t* self, cef_browser_t* browser, int next);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnSetFocusDelegate(cef_focus_handler_t* self, cef_browser_t* browser,
			CefFocusSource source);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnGotFocusDelegate(cef_focus_handler_t* self, cef_browser_t* browser);
	}
}