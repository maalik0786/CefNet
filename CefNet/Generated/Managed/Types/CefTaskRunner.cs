...
namespace CefNet
{
	...
	public unsafe partial class CefTaskRunner : CefBaseRefCounted<cef_task_runner_t>
	{
		...
		internal static CefTaskRunner Create(IntPtr instance)
		{
		...
		///  |that| object.
		/// </summary>
		public virtual bool IsSame(CefTaskRunner that)
		{
		...
		/// </summary>
		public virtual bool BelongsToCurrentThread()
		{
		...
		/// </summary>
		public virtual bool BelongsToThread(CefThreadId threadId)
		{
		...
		/// </summary>
		public virtual int PostTask(CefTask task)
		{
		...
		///  specified delay.
		/// </summary>
		public virtual int PostDelayedTask(CefTask task, long delayMs)
		{
