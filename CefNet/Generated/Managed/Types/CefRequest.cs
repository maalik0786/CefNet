...
namespace CefNet
{
	...
	public unsafe partial class CefRequest : CefBaseRefCounted<cef_request_t>
	{
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetUrl()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetMethod()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		///  The resulting string must be freed by calling cef_string_userfree_free().
		/// </summary>
		public virtual string ReferrerUrl => SafeCall(CefString.ReadAndFree(NativeInstance->GetReferrerUrl()));

		/// <summary>
		///  Get the referrer policy.
		/// </summary>
		public virtual CefReferrerPolicy ReferrerPolicy => SafeCall(NativeInstance->GetReferrerPolicy());

		/// <summary>
		///  Gets and sets the post data.
		/// </summary>
		public virtual CefPostData PostData
		{
			get => SafeCall(CefPostData.Wrap(CefPostData.Create, NativeInstance->GetPostData()));
			set
			{
		...
		{
			get => SafeCall(NativeInstance->GetFlags());
			set
			{
		...
		///  The resulting string must be freed by calling cef_string_userfree_free().
		/// </summary>
		public virtual string FirstPartyForCookies
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetFirstPartyForCookies()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		///  process.
		/// </summary>
		public virtual CefResourceType ResourceType => SafeCall(NativeInstance->GetResourceType());
		...
		/// </summary>
		public virtual ulong Identifier => SafeCall(NativeInstance->GetIdentifier());

		internal static CefRequest Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void SetReferrer(string referrerUrl, CefReferrerPolicy policy)
		{
		...
		/// </summary>
		public virtual void GetHeaderMap(CefStringMultimap headerMap)
		{
		...
		/// </summary>
		public virtual void Set(string url, string method, CefPostData postData, CefStringMultimap headerMap)
		{
			fixed (char* s0 = url)
		...
		/// </summary>
		public virtual void SetHeaderMap(CefStringMultimap headerMap)
		{
