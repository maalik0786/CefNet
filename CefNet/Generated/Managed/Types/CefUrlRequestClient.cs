...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefUrlRequestClient : CefBaseRefCounted<cef_urlrequest_client_t>, ICefUrlRequestClientPrivate
	{
		...
		internal static CefUrlRequestClient Create(IntPtr instance)
		{
		...
		///  successful or not.
		/// </summary>
		protected internal virtual void OnRequestComplete(CefUrlRequest request)
		{
		}

		// void (*)(_cef_urlrequest_client_t* self, _cef_urlrequest_t* request)*
		private static void OnRequestCompleteImpl(cef_urlrequest_client_t* self, cef_urlrequest_t* request)
		{
		...
		/// </summary>
		protected internal virtual void OnUploadProgress(CefUrlRequest request, long current, long total)
		{
		}

		// void (*)(_cef_urlrequest_client_t* self, _cef_urlrequest_t* request, int64 current, int64 total)*
		private static void OnUploadProgressImpl(cef_urlrequest_client_t* self, cef_urlrequest_t* request, long current,
			long total)
		{
			var instance = GetInstance((IntPtr) self) as CefUrlRequestClient;
		...
		/// </summary>
		protected internal virtual void OnDownloadProgress(CefUrlRequest request, long current, long total)
		{
		}

		// void (*)(_cef_urlrequest_client_t* self, _cef_urlrequest_t* request, int64 current, int64 total)*
		private static void OnDownloadProgressImpl(cef_urlrequest_client_t* self, cef_urlrequest_t* request,
		...
		/// </summary>
		protected internal virtual void OnDownloadData(CefUrlRequest request, IntPtr data, long dataLength)
		{
		}

		// void (*)(_cef_urlrequest_client_t* self, _cef_urlrequest_t* request, const void* data, size_t data_length)*
		private static void OnDownloadDataImpl(cef_urlrequest_client_t* self, cef_urlrequest_t* request, void* data,
			UIntPtr data_length)
		{
			var instance = GetInstance((IntPtr) self) as CefUrlRequestClient;
			...
			instance.OnDownloadData(CefUrlRequest.Wrap(CefUrlRequest.Create, request), (IntPtr) data,
				(long) data_length);
		}
		...
		/// </summary>
		protected internal virtual bool GetAuthCredentials(bool isProxy, string host, int port, string realm,
		...
		private static int GetAuthCredentialsImpl(cef_urlrequest_client_t* self, int isProxy, cef_string_t* host,
			int port, cef_string_t* realm, cef_string_t* scheme, cef_auth_callback_t* callback)
		{
			var instance = GetInstance((IntPtr) self) as CefUrlRequestClient;
			...
			return instance.GetAuthCredentials(isProxy != 0, CefString.Read(host), port, CefString.Read(realm),
				CefString.Read(scheme), CefAuthCallback.Wrap(CefAuthCallback.Create, callback))
				? 1
				: 0;
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnRequestCompleteDelegate(cef_urlrequest_client_t* self, cef_urlrequest_t* request);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnUploadProgressDelegate(cef_urlrequest_client_t* self, cef_urlrequest_t* request,
			long current, long total);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDownloadProgressDelegate(cef_urlrequest_client_t* self, cef_urlrequest_t* request,
			long current, long total);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDownloadDataDelegate(cef_urlrequest_client_t* self, cef_urlrequest_t* request,
			void* data, UIntPtr data_length);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetAuthCredentialsDelegate(cef_urlrequest_client_t* self, int isProxy, cef_string_t* host,
			int port, cef_string_t* realm, cef_string_t* scheme, cef_auth_callback_t* callback);
	}
}