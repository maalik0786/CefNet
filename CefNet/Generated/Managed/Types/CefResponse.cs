...
namespace CefNet
{
	...
	public unsafe partial class CefResponse : CefBaseRefCounted<cef_response_t>
	{
		...
		/// </summary>
		public virtual CefErrorCode Error
		{
			get => SafeCall(NativeInstance->GetError());
			set
			{
		...
		{
			get => SafeCall(NativeInstance->GetStatus());
			set
			{
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetStatusText()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetMimeType()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetCharset()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		internal static CefResponse Create(IntPtr instance)
		{
