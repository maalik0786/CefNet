...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefResponseFilter : CefBaseRefCounted<cef_response_filter_t>, ICefResponseFilterPrivate
	{
		...
		internal static CefResponseFilter Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool InitFilter()
		{
			return default;
		}

		// int (*)(_cef_response_filter_t* self)*
		private static int InitFilterImpl(cef_response_filter_t* self)
		{
		...
		/// </summary>
		protected internal virtual CefResponseFilterStatus Filter(IntPtr dataIn, long dataInSize, ref long dataInRead,
			IntPtr dataOut, long dataOutSize, ref long dataOutWritten)
		{
			return default;
		}
		...
		private static CefResponseFilterStatus FilterImpl(cef_response_filter_t* self, void* data_in,
			UIntPtr data_in_size, UIntPtr* data_in_read, void* data_out, UIntPtr data_out_size,
			UIntPtr* data_out_written)
		{
			var instance = GetInstance((IntPtr) self) as CefResponseFilter;
			if (instance == null || ((ICefResponseFilterPrivate) instance).AvoidFilter()) return default;
			var c3 = (long) *data_in_read;
			var c6 = (long) *data_out_written;
			var rv = instance.Filter((IntPtr) data_in, (long) data_in_size, ref c3, (IntPtr) data_out,
				(long) data_out_size, ref c6);
		...
		private delegate int InitFilterDelegate(cef_response_filter_t* self);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate CefResponseFilterStatus FilterDelegate(cef_response_filter_t* self, void* data_in,
			UIntPtr data_in_size, UIntPtr* data_in_read, void* data_out, UIntPtr data_out_size,
			UIntPtr* data_out_written);
	}
}