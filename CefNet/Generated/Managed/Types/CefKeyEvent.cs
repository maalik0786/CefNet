...
namespace CefNet
{
	...
	public struct CefKeyEvent
	{
		...
		{
			get => _instance.windows_key_code;
			set => _instance.windows_key_code = value;
		}
		...
		{
			get => _instance.native_key_code;
			set => _instance.native_key_code = value;
		}
		...
		{
			get => _instance.is_system_key != 0;
			set => _instance.is_system_key = value ? 1 : 0;
		}
		...
		{
			get => _instance.character;
			set => _instance.character = value;
		}
		...
		{
			get => _instance.unmodified_character;
			set => _instance.unmodified_character = value;
		}
		...
		{
			get => _instance.focus_on_editable_field != 0;
			set => _instance.focus_on_editable_field = value ? 1 : 0;
		}
