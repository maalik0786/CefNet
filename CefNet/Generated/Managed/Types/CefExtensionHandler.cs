...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefExtensionHandler : CefBaseRefCounted<cef_extension_handler_t>, ICefExtensionHandlerPrivate
	{
		...
		private static readonly OnBeforeBackgroundBrowserDelegate fnOnBeforeBackgroundBrowser =
			OnBeforeBackgroundBrowserImpl;
		...
		public CefExtensionHandler()
		{
			...
			self->on_before_background_browser =
				(void*) Marshal.GetFunctionPointerForDelegate(fnOnBeforeBackgroundBrowser);
		...
		internal static CefExtensionHandler Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual void OnExtensionLoadFailed(CefErrorCode result)
		{
		}

		// void (*)(_cef_extension_handler_t* self, cef_errorcode_t result)*
		private static void OnExtensionLoadFailedImpl(cef_extension_handler_t* self, CefErrorCode result)
		{
			var instance = GetInstance((IntPtr) self) as CefExtensionHandler;
			if (instance == null || ((ICefExtensionHandlerPrivate) instance).AvoidOnExtensionLoadFailed()) return;
		...
		/// </summary>
		protected internal virtual void OnExtensionLoaded(CefExtension extension)
		{
		}

		// void (*)(_cef_extension_handler_t* self, _cef_extension_t* extension)*
		private static void OnExtensionLoadedImpl(cef_extension_handler_t* self, cef_extension_t* extension)
		{
			var instance = GetInstance((IntPtr) self) as CefExtensionHandler;
		...
		/// </summary>
		protected internal virtual void OnExtensionUnloaded(CefExtension extension)
		{
		}

		// void (*)(_cef_extension_handler_t* self, _cef_extension_t* extension)*
		private static void OnExtensionUnloadedImpl(cef_extension_handler_t* self, cef_extension_t* extension)
		{
			var instance = GetInstance((IntPtr) self) as CefExtensionHandler;
		...
		/// </summary>
		protected internal virtual bool OnBeforeBackgroundBrowser(CefExtension extension, string url,
		...
		private static int OnBeforeBackgroundBrowserImpl(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_string_t* url, cef_client_t** client, cef_browser_settings_t* settings)
		{
			...
			var obj_client = CefClient.Wrap(CefClient.Create, *client);
			var rv = instance.OnBeforeBackgroundBrowser(CefExtension.Wrap(CefExtension.Create, extension),
				CefString.Read(url), ref obj_client, new CefBrowserSettings(settings))
				? 1
				: 0;
		...
		/// </summary>
		protected internal virtual bool OnBeforeBrowser(CefExtension extension, CefBrowser browser,
			CefBrowser activeBrowser, int index, string url, bool active, CefWindowInfo windowInfo,
			ref CefClient client, CefBrowserSettings settings)
		{
			return default;
		}
		...
		private static int OnBeforeBrowserImpl(cef_extension_handler_t* self, cef_extension_t* extension,
			...
			cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings)
		{
			...
			var obj_client = CefClient.Wrap(CefClient.Create, *client);
			var rv = instance.OnBeforeBrowser(CefExtension.Wrap(CefExtension.Create, extension),
				CefBrowser.Wrap(CefBrowser.Create, browser), CefBrowser.Wrap(CefBrowser.Create, active_browser), index,
				CefString.Read(url), active != 0, CefWindowInfo.Wrap(windowInfo), ref obj_client,
		...
		/// </summary>
		protected internal virtual CefBrowser GetActiveBrowser(CefExtension extension, CefBrowser browser,
		...
		private static cef_browser_t* GetActiveBrowserImpl(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, int include_incognito)
		{
			...
			var rv = instance.GetActiveBrowser(CefExtension.Wrap(CefExtension.Create, extension),
				CefBrowser.Wrap(CefBrowser.Create, browser), include_incognito != 0);
			if (rv == null)
				return null;
		...
		/// </summary>
		protected internal virtual bool CanAccessBrowser(CefExtension extension, CefBrowser browser,
			bool includeIncognito, CefBrowser targetBrowser)
		{
			return default;
		}
		...
		private static int CanAccessBrowserImpl(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, int include_incognito, cef_browser_t* target_browser)
		{
			...
			return instance.CanAccessBrowser(CefExtension.Wrap(CefExtension.Create, extension),
				CefBrowser.Wrap(CefBrowser.Create, browser), include_incognito != 0,
				CefBrowser.Wrap(CefBrowser.Create, target_browser))
				? 1
				: 0;
		}
		...
		/// </summary>
		protected internal virtual bool GetExtensionResource(CefExtension extension, CefBrowser browser, string file,
		...
		private static int GetExtensionResourceImpl(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, cef_string_t* file, cef_get_extension_resource_callback_t* callback)
		{
			...
			return instance.GetExtensionResource(CefExtension.Wrap(CefExtension.Create, extension),
				CefBrowser.Wrap(CefBrowser.Create, browser), CefString.Read(file),
				CefGetExtensionResourceCallback.Wrap(CefGetExtensionResourceCallback.Create, callback))
				? 1
				: 0;
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnExtensionLoadFailedDelegate(cef_extension_handler_t* self, CefErrorCode result);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnExtensionLoadedDelegate(cef_extension_handler_t* self, cef_extension_t* extension);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnExtensionUnloadedDelegate(cef_extension_handler_t* self, cef_extension_t* extension);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnBeforeBackgroundBrowserDelegate(cef_extension_handler_t* self,
			cef_extension_t* extension, cef_string_t* url, cef_client_t** client, cef_browser_settings_t* settings);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnBeforeBrowserDelegate(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, cef_browser_t* active_browser, int index, cef_string_t* url, int active,
			cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate cef_browser_t* GetActiveBrowserDelegate(cef_extension_handler_t* self,
			cef_extension_t* extension, cef_browser_t* browser, int include_incognito);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int CanAccessBrowserDelegate(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, int include_incognito, cef_browser_t* target_browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetExtensionResourceDelegate(cef_extension_handler_t* self, cef_extension_t* extension,
			cef_browser_t* browser, cef_string_t* file, cef_get_extension_resource_callback_t* callback);
	}
}