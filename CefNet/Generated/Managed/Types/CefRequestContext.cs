...
namespace CefNet
{
	...
	public unsafe partial class CefRequestContext : CefBaseRefCounted<cef_request_context_t>
	{
		...
		///  context argument.
		/// </summary>
		public virtual bool IsGlobal => SafeCall(NativeInstance->IsGlobal() != 0);

		/// <summary>
		///  Gets the handler for this context if any.
		/// </summary>
		public virtual CefRequestContextHandler Handler =>
			SafeCall(CefRequestContextHandler.Wrap(CefRequestContextHandler.Create, NativeInstance->GetHandler()));
		...
		/// </summary>
		public virtual string CachePath => SafeCall(CefString.ReadAndFree(NativeInstance->GetCachePath()));

		/// <summary>
		///  Gets the MediaRouter object associated with this context.
		/// </summary>
		public virtual CefMediaRouter MediaRouter =>
			SafeCall(CefMediaRouter.Wrap(CefMediaRouter.Create, NativeInstance->GetMediaRouter()));

		internal static CefRequestContext Create(IntPtr instance)
		{
		...
		///  object.
		/// </summary>
		public virtual bool IsSame(CefRequestContext other)
		{
		...
		///  object.
		/// </summary>
		public virtual bool IsSharingWith(CefRequestContext other)
		{
		...
		/// </summary>
		public virtual CefCookieManager GetCookieManager(CefCompletionCallback callback)
		{
			return SafeCall(CefCookieManager.Wrap(CefCookieManager.Create,
				NativeInstance->GetCookieManager(callback != null ? callback.GetNativeInstance() : null)));
		}
		...
		/// </summary>
		public virtual bool RegisterSchemeHandlerFactory(string schemeName, string domainName,
			CefSchemeHandlerFactory factory)
		{
			...
			fixed (char* s1 = domainName)
			{
				...
				return SafeCall(NativeInstance->RegisterSchemeHandlerFactory(&cstr0, &cstr1,
					factory != null ? factory.GetNativeInstance() : null) != 0);
			}
		}
		...
		/// </summary>
		public virtual CefValue GetPreference(string name)
		{
			fixed (char* s0 = name)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = name != null ? name.Length : 0};
		...
		///  thread.
		/// </summary>
		public virtual CefDictionaryValue GetAllPreferences(bool includeDefaults)
		{
			return SafeCall(CefDictionaryValue.Wrap(CefDictionaryValue.Create,
				NativeInstance->GetAllPreferences(includeDefaults ? 1 : 0)));
		}
		...
		/// </summary>
		public virtual bool SetPreference(string name, CefValue value, ref string error)
		{
			fixed (char* s0 = name)
			fixed (char* s2 = error)
			{
				...
				var rv =
					NativeInstance->SetPreference(&cstr0, value != null ? value.GetNativeInstance() : null, &cstr2) !=
					0;
		...
		///  completion.
		/// </summary>
		public virtual void ClearCertificateExceptions(CefCompletionCallback callback)
		{
		...
		/// </summary>
		public virtual void ClearHttpAuthCredentials(CefCompletionCallback callback)
		{
		...
		///  on the UI thread after completion.
		/// </summary>
		public virtual void CloseAllConnections(CefCompletionCallback callback)
		{
		...
		/// </summary>
		public virtual void ResolveHost(string origin, CefResolveCallback callback)
		{
		...
		/// </summary>
		public virtual void LoadExtension(string rootDirectory, CefDictionaryValue manifest,
			CefExtensionHandler handler)
		{
			fixed (char* s0 = rootDirectory)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = rootDirectory != null ? rootDirectory.Length : 0};
				NativeInstance->LoadExtension(&cstr0, manifest != null ? manifest.GetNativeInstance() : null,
		...
		///  the browser process UI thread.
		/// </summary>
		public virtual bool DidLoadExtension(string extensionId)
		{
		...
		/// </summary>
		public virtual bool HasExtension(string extensionId)
		{
			fixed (char* s0 = extensionId)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = extensionId != null ? extensionId.Length : 0};
		...
		///  browser process UI thread.
		/// </summary>
		public virtual bool GetExtensions(CefStringList extensionIds)
		{
		...
		/// </summary>
		public virtual CefExtension GetExtension(string extensionId)
		{
			fixed (char* s0 = extensionId)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = extensionId != null ? extensionId.Length : 0};
