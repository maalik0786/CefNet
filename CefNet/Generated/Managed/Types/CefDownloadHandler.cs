...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefDownloadHandler : CefBaseRefCounted<cef_download_handler_t>, ICefDownloadHandlerPrivate
	{
		...
		internal static CefDownloadHandler Create(IntPtr instance)
		{
		...
		private static void OnBeforeDownloadImpl(cef_download_handler_t* self, cef_browser_t* browser,
			cef_download_item_t* download_item, cef_string_t* suggested_name, cef_before_download_callback_t* callback)
		{
			...
			instance.OnBeforeDownload(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefDownloadItem.Wrap(CefDownloadItem.Create, download_item), CefString.Read(suggested_name),
				CefBeforeDownloadCallback.Wrap(CefBeforeDownloadCallback.Create, callback));
		}
		...
		private static void OnDownloadUpdatedImpl(cef_download_handler_t* self, cef_browser_t* browser,
			cef_download_item_t* download_item, cef_download_item_callback_t* callback)
		{
			...
			instance.OnDownloadUpdated(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefDownloadItem.Wrap(CefDownloadItem.Create, download_item),
				CefDownloadItemCallback.Wrap(CefDownloadItemCallback.Create, callback));
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnBeforeDownloadDelegate(cef_download_handler_t* self, cef_browser_t* browser,
			cef_download_item_t* download_item, cef_string_t* suggested_name, cef_before_download_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDownloadUpdatedDelegate(cef_download_handler_t* self, cef_browser_t* browser,
			cef_download_item_t* download_item, cef_download_item_callback_t* callback);
	}
}