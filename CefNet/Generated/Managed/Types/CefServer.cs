...
namespace CefNet
{
	...
	public unsafe partial class CefServer : CefBaseRefCounted<cef_server_t>
	{
		...
		/// </summary>
		public virtual CefTaskRunner TaskRunner =>
			SafeCall(CefTaskRunner.Wrap(CefTaskRunner.Create, NativeInstance->GetTaskRunner()));
		...
		/// </summary>
		public virtual bool IsRunning => SafeCall(NativeInstance->IsRunning() != 0);

		/// <summary>
		///  Gets the server address including the port number.
		///  The resulting string must be freed by calling cef_string_userfree_free().
		/// </summary>
		public virtual string Address => SafeCall(CefString.ReadAndFree(NativeInstance->GetAddress()));

		/// <summary>
		///  Gets a value indicating whether the server currently has a connection. This property
		///  must be called on the dedicated server thread.
		/// </summary>
		public virtual bool HasConnection => SafeCall(NativeInstance->HasConnection() != 0);

		internal static CefServer Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual bool IsValidConnection(int connectionId)
		{
		...
		/// </summary>
		public virtual void SendHttp200response(int connectionId, string contentType, IntPtr data, long dataSize)
		{
		...
		///  response is sent.
		/// </summary>
		public virtual void SendHttp404response(int connectionId)
		{
		...
		///  sent.
		/// </summary>
		public virtual void SendHttp500response(int connectionId, string errorMessage)
		{
		...
		/// </summary>
		public virtual void SendHttpResponse(int connectionId, int responseCode, string contentType, long contentLength,
			CefStringMultimap extraHeaders)
		{
		...
		/// </summary>
		public virtual void SendRawData(int connectionId, IntPtr data, long dataSize)
		{
		...
		/// </summary>
		public virtual void SendWebSocketMessage(int connectionId, IntPtr data, long dataSize)
		{
