...
namespace CefNet
{
	...
	public unsafe partial class CefPrintSettings : CefBaseRefCounted<cef_print_settings_t>
	{
		...
		/// </summary>
		public virtual bool IsLandscape => SafeCall(NativeInstance->IsLandscape() != 0);
		...
		{
			get => SafeCall(CefString.ReadAndFree(NativeInstance->GetDeviceName()));
			set
			{
				fixed (char* s0 = value)
				{
		...
		{
			get => SafeCall(NativeInstance->GetDpi());
			set
			{
		...
		/// </summary>
		public virtual long PageRangesCount => SafeCall((long) NativeInstance->GetPageRangesCount());
		...
		{
			get => SafeCall(NativeInstance->IsSelectionOnly() != 0);
			set
			{
		...
		/// </summary>
		public virtual CefColorModel ColorModel
		{
			get => SafeCall(NativeInstance->GetColorModel());
			set
			{
		...
		{
			get => SafeCall(NativeInstance->GetCopies());
			set
			{
		...
		/// </summary>
		public virtual CefDuplexMode DuplexMode
		{
			get => SafeCall(NativeInstance->GetDuplexMode());
			set
			{
		...
		internal static CefPrintSettings Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void SetPrinterPrintableArea(CefSize physicalSizeDeviceUnits, CefRect printableAreaDeviceUnits,
			bool landscapeNeedsFlip)
		{
			NativeInstance->SetPrinterPrintableArea((cef_size_t*) &physicalSizeDeviceUnits,
				(cef_rect_t*) &printableAreaDeviceUnits, landscapeNeedsFlip ? 1 : 0);
			GC.KeepAlive(this);
		}
		...
		///  Set the page ranges.
		/// </summary>
		public virtual void SetPageRanges(CefRange[] ranges)
		{
		...
		/// </summary>
		public virtual void GetPageRanges(ref long rangesCount, ref CefRange[] ranges)
		{
			fixed (CefRange* p1 = ranges)
			{
				var c1 = new UIntPtr((uint) ranges.Length);
		...
		/// </summary>
		public virtual bool WillCollate()
		{
		...
		/// </summary>
		public virtual void SetOrientation(bool landscape)
		{
