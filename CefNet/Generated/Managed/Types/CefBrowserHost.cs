...
namespace CefNet
{
	...
	///  Role: Proxy
	/// </remarks>
	public unsafe class CefBrowserHost : CefBaseRefCounted<cef_browser_host_t>
	{
		...
		/// </summary>
		public virtual CefBrowser Browser => SafeCall(CefBrowser.Wrap(CefBrowser.Create, NativeInstance->GetBrowser()));
		...
		/// </summary>
		public virtual IntPtr WindowHandle => SafeCall(NativeInstance->GetWindowHandle());
		...
		/// </summary>
		public virtual IntPtr OpenerWindowHandle => SafeCall(NativeInstance->GetOpenerWindowHandle());

		/// <summary>
		///  Gets a value indicating whether this browser is wrapped in a cef_browser_view_t.
		/// </summary>
		public virtual bool HasView => SafeCall(NativeInstance->HasView() != 0);

		/// <summary>
		///  Gets the client for this browser.
		/// </summary>
		public virtual CefClient Client => SafeCall(CefClient.Wrap(CefClient.Create, NativeInstance->GetClient()));

		/// <summary>
		///  Gets the request context for this browser.
		/// </summary>
		public virtual CefRequestContext RequestContext =>
			SafeCall(CefRequestContext.Wrap(CefRequestContext.Create, NativeInstance->GetRequestContext()));
		...
		{
			get => SafeCall(NativeInstance->GetZoomLevel());
			set
			{
		...
		/// </summary>
		public virtual bool HasDevTools => SafeCall(NativeInstance->HasDevTools() != 0);

		/// <summary>
		///  Gets or sets a value indicating whether mouse cursor change is disabled.
		/// </summary>
		public virtual bool MouseCursorChangeDisabled
		{
			get => SafeCall(NativeInstance->IsMouseCursorChangeDisabled() != 0);
			set
			{
		...
		/// </summary>
		public virtual bool IsWindowRenderingDisabled => SafeCall(NativeInstance->IsWindowRenderingDisabled() != 0);
		...
		/// </summary>
		public virtual int WindowlessFrameRate
		{
			get => SafeCall(NativeInstance->GetWindowlessFrameRate());
			set
			{
		...
		/// </summary>
		public virtual CefNavigationEntry VisibleNavigationEntry => SafeCall(
			CefNavigationEntry.Wrap(CefNavigationEntry.Create, NativeInstance->GetVisibleNavigationEntry()));

		/// <summary>
		///  Gets the extension hosted in this browser or NULL if no extension is
		///  hosted. See cef_request_context_t::LoadExtension for details.
		/// </summary>
		public virtual CefExtension Extension =>
			SafeCall(CefExtension.Wrap(CefExtension.Create, NativeInstance->GetExtension()));
		...
		/// </summary>
		public virtual bool IsBackgroundHost => SafeCall(NativeInstance->IsBackgroundHost() != 0);
		...
		{
			get => SafeCall(NativeInstance->IsAudioMuted() != 0);
			set
			{
		...
		internal static CefBrowserHost Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void RunFileDialog(CefFileDialogMode mode, string title, string defaultFilePath,
			CefStringList acceptFilters, bool selectedAcceptFilter, CefRunFileDialogCallback callback)
		{
			fixed (char* s1 = title)
			fixed (char* s2 = defaultFilePath)
			{
				...
				NativeInstance->RunFileDialog(mode, &cstr1, &cstr2, acceptFilters.GetNativeInstance(),
					selectedAcceptFilter ? 1 : 0, callback != null ? callback.GetNativeInstance() : null);
			}
		...
		/// </summary>
		public virtual void DownloadImage(string imageUrl, bool isFavicon, uint maxImageSize, bool bypassCache,
			CefDownloadImageCallback callback)
		{
			fixed (char* s0 = imageUrl)
			{
				...
				NativeInstance->DownloadImage(&cstr0, isFavicon ? 1 : 0, maxImageSize, bypassCache ? 1 : 0,
					callback != null ? callback.GetNativeInstance() : null);
			}
		...
		/// </summary>
		public virtual void PrintToPdf(string path, CefPdfPrintSettings settings, CefPdfPrintCallback callback)
		{
			fixed (char* s0 = path)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = path != null ? path.Length : 0};
				NativeInstance->PrintToPdf(&cstr0, (cef_pdf_print_settings_t*) &settings,
					callback != null ? callback.GetNativeInstance() : null);
			}
		...
		/// </summary>
		public virtual void Find(int identifier, string searchText, bool forward, bool matchCase, bool findNext)
		{
		...
		/// </summary>
		public virtual void ShowDevTools(CefWindowInfo windowInfo, CefClient client, CefBrowserSettings settings,
			CefPoint inspectElementAt)
		{
			NativeInstance->ShowDevTools(windowInfo.GetNativeInstance(),
				client != null ? client.GetNativeInstance() : null, settings.GetNativeInstance(),
				(cef_point_t*) &inspectElementAt);
			GC.KeepAlive(this);
		}
		...
		///  &gt;` command-line flag.
		/// </summary>
		public virtual bool SendDevToolsMessage(IntPtr message, long messageSize)
		{
			return SafeCall(NativeInstance->SendDevToolsMessage((void*) message, new UIntPtr((ulong) messageSize)) !=
			                0);
		}
		...
		/// </summary>
		public virtual int ExecuteDevToolsMethod(int messageId, string method, CefDictionaryValue @params)
		{
			fixed (char* s1 = method)
			{
				var cstr1 = new cef_string_t {Str = s1, Length = method != null ? method.Length : 0};
				return SafeCall(NativeInstance->ExecuteDevToolsMethod(messageId, &cstr1,
					@params != null ? @params.GetNativeInstance() : null));
			}
		}
		...
		/// </summary>
		public virtual CefRegistration AddDevToolsMessageObserver(CefDevToolsMessageObserver observer)
		{
			return SafeCall(CefRegistration.Wrap(CefRegistration.Create,
				NativeInstance->AddDevToolsMessageObserver(observer != null ? observer.GetNativeInstance() : null)));
		}
		...
		///  sent.
		/// </summary>
		public virtual void GetNavigationEntries(CefNavigationEntryVisitor visitor, bool currentOnly)
		{
			NativeInstance->GetNavigationEntries(visitor != null ? visitor.GetNativeInstance() : null,
				currentOnly ? 1 : 0);
			GC.KeepAlive(this);
		}
		...
		/// </summary>
		public virtual void WasHidden(int hidden)
		{
		...
		///  disabled.
		/// </summary>
		public virtual void Invalidate(CefPaintElementType type)
		{
		...
		/// </summary>
		public virtual void SendKeyEvent(CefKeyEvent @event)
		{
		...
		/// </summary>
		public virtual void SendMouseClickEvent(CefMouseEvent @event, CefMouseButtonType type, bool mouseUp,
			int clickCount)
		{
		...
		///  relative to the upper-left corner of the view.
		/// </summary>
		public virtual void SendMouseMoveEvent(CefMouseEvent @event, bool mouseLeave)
		{
		...
		/// </summary>
		public virtual void SendMouseWheelEvent(CefMouseEvent @event, int deltaX, int deltaY)
		{
		...
		/// </summary>
		public virtual void SendTouchEvent(CefTouchEvent @event)
		{
		...
		/// </summary>
		public virtual void ImeSetComposition(string text, CefCompositionUnderline[] underlines,
			CefRange replacementRange, CefRange selectionRange)
		{
			...
			fixed (CefCompositionUnderline* p2 = underlines)
			{
				...
				NativeInstance->ImeSetComposition(&cstr0, new UIntPtr((uint) underlines.Length),
					(cef_composition_underline_t*) p2, (cef_range_t*) &replacementRange,
					(cef_range_t*) &selectionRange);
			}
		...
		/// </summary>
		public virtual void ImeCommitText(string text, CefRange replacementRange, int relativeCursorPos)
		{
			fixed (char* s0 = text)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = text != null ? text.Length : 0};
		...
		/// </summary>
		public virtual void DragTargetDragEnter(CefDragData dragData, CefMouseEvent @event,
			CefDragOperationsMask allowedOps)
		{
			NativeInstance->DragTargetDragEnter(dragData != null ? dragData.GetNativeInstance() : null,
				(cef_mouse_event_t*) &@event, allowedOps);
			GC.KeepAlive(this);
		}
		...
		/// </summary>
		public virtual void DragTargetDragOver(CefMouseEvent @event, CefDragOperationsMask allowedOps)
		{
		...
		///  is disabled.
		/// </summary>
		public virtual void DragTargetDrop(CefMouseEvent @event)
		{
		...
		///  disabled.
		/// </summary>
		public virtual void DragSourceEndedAt(int x, int y, CefDragOperationsMask op)
		{
		...
		/// </summary>
		public virtual void SetAutoResizeEnabled(int enabled, CefSize minSize, CefSize maxSize)
		{
