...
namespace CefNet
{
	...
	public struct CefScreenInfo
	{
		...
		{
			get => _instance.device_scale_factor;
			set => _instance.device_scale_factor = value;
		}
		...
		{
			get => _instance.depth_per_component;
			set => _instance.depth_per_component = value;
		}
		...
		{
			get => _instance.is_monochrome != 0;
			set => _instance.is_monochrome = value ? 1 : 0;
		}
		...
		{
			get => _instance.available_rect;
			set => _instance.available_rect = value;
		}
