...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefDevToolsMessageObserver : CefBaseRefCounted<cef_dev_tools_message_observer_t>,
		ICefDevToolsMessageObserverPrivate
	{
		...
		public CefDevToolsMessageObserver()
		{
			...
			self->on_dev_tools_agent_attached =
				(void*) Marshal.GetFunctionPointerForDelegate(fnOnDevToolsAgentAttached);
		...
		internal static CefDevToolsMessageObserver Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool OnDevToolsMessage(CefBrowser browser, IntPtr message, long messageSize)
		{
			return default;
		}

		// int (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser, const void* message, size_t message_size)*
		private static int OnDevToolsMessageImpl(cef_dev_tools_message_observer_t* self, cef_browser_t* browser,
			void* message, UIntPtr message_size)
		{
			...
			return instance.OnDevToolsMessage(CefBrowser.Wrap(CefBrowser.Create, browser), (IntPtr) message,
				(long) message_size)
				? 1
				: 0;
		}
		...
		///  contents.
		/// </summary>
		protected internal virtual void OnDevToolsMethodResult(CefBrowser browser, int messageId, bool success,
		...
		private static void OnDevToolsMethodResultImpl(cef_dev_tools_message_observer_t* self, cef_browser_t* browser,
			int message_id, int success, void* result, UIntPtr result_size)
		{
			...
			instance.OnDevToolsMethodResult(CefBrowser.Wrap(CefBrowser.Create, browser), message_id, success != 0,
				(IntPtr) result, (long) result_size);
		}
		...
		/// </summary>
		protected internal virtual void OnDevToolsEvent(CefBrowser browser, string method, IntPtr @params,
			long paramsSize)
		{
		}
		...
		private static void OnDevToolsEventImpl(cef_dev_tools_message_observer_t* self, cef_browser_t* browser,
			cef_string_t* method, void* @params, UIntPtr params_size)
		{
			...
			instance.OnDevToolsEvent(CefBrowser.Wrap(CefBrowser.Create, browser), CefString.Read(method),
				(IntPtr) @params, (long) params_size);
		}
		...
		/// </summary>
		protected internal virtual void OnDevToolsAgentAttached(CefBrowser browser)
		{
		}

		// void (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser)*
		private static void OnDevToolsAgentAttachedImpl(cef_dev_tools_message_observer_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefDevToolsMessageObserver;
		...
		/// </summary>
		protected internal virtual void OnDevToolsAgentDetached(CefBrowser browser)
		{
		}

		// void (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser)*
		private static void OnDevToolsAgentDetachedImpl(cef_dev_tools_message_observer_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefDevToolsMessageObserver;
		...
		private delegate int OnDevToolsMessageDelegate(cef_dev_tools_message_observer_t* self, cef_browser_t* browser,
			void* message, UIntPtr message_size);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDevToolsMethodResultDelegate(cef_dev_tools_message_observer_t* self,
			cef_browser_t* browser, int message_id, int success, void* result, UIntPtr result_size);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDevToolsEventDelegate(cef_dev_tools_message_observer_t* self, cef_browser_t* browser,
			cef_string_t* method, void* @params, UIntPtr params_size);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDevToolsAgentAttachedDelegate(cef_dev_tools_message_observer_t* self,
			cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDevToolsAgentDetachedDelegate(cef_dev_tools_message_observer_t* self,
			cef_browser_t* browser);
	}
}