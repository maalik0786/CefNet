...
namespace CefNet
{
	...
	public unsafe partial class CefListValue : CefBaseRefCounted<cef_list_value_t>
	{
		...
		internal static CefListValue Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual bool IsSame(CefListValue that)
		{
		...
		/// </summary>
		public virtual bool IsEqual(CefListValue that)
		{
		...
		/// </summary>
		public virtual CefListValue Copy()
		{
		...
		/// </summary>
		public virtual int Remove(long index)
		{
		...
		/// </summary>
		public virtual CefValueType GetType(long index)
		{
		...
		/// </summary>
		public virtual CefValue GetValue(long index)
		{
		...
		/// </summary>
		public virtual int GetBool(long index)
		{
		...
		/// </summary>
		public virtual int GetInt(long index)
		{
		...
		/// </summary>
		public virtual double GetDouble(long index)
		{
		...
		/// </summary>
		public virtual CefBinaryValue GetBinary(long index)
		{
			return SafeCall(CefBinaryValue.Wrap(CefBinaryValue.Create,
				NativeInstance->GetBinary(new UIntPtr((ulong) index))));
		}
		...
		///  modify this object.
		/// </summary>
		public virtual CefDictionaryValue GetDictionary(long index)
		{
			return SafeCall(CefDictionaryValue.Wrap(CefDictionaryValue.Create,
				NativeInstance->GetDictionary(new UIntPtr((ulong) index))));
		}
		...
		///  this object.
		/// </summary>
		public virtual CefListValue GetList(long index)
		{
			return SafeCall(Wrap(Create, NativeInstance->GetList(new UIntPtr((ulong) index))));
		}
		...
		///  will modify this object.
		/// </summary>
		public virtual bool SetValue(long index, CefValue value)
		{
			return SafeCall(NativeInstance->SetValue(new UIntPtr((ulong) index),
				value != null ? value.GetNativeInstance() : null) != 0);
		}
		...
		/// </summary>
		public virtual bool SetNull(long index)
		{
		...
		///  value was set successfully.
		/// </summary>
		public virtual bool SetBool(long index, bool value)
		{
		...
		///  value was set successfully.
		/// </summary>
		public virtual bool SetInt(long index, int value)
		{
		...
		/// </summary>
		public virtual bool SetDouble(long index, double value)
		{
		...
		///  the value was set successfully.
		/// </summary>
		public virtual bool SetString(long index, string value)
		{
			fixed (char* s1 = value)
			{
		...
		/// </summary>
		public virtual bool SetBinary(long index, CefBinaryValue value)
		{
			return SafeCall(NativeInstance->SetBinary(new UIntPtr((ulong) index),
				value != null ? value.GetNativeInstance() : null) != 0);
		}
		...
		/// </summary>
		public virtual bool SetDictionary(long index, CefDictionaryValue value)
		{
			return SafeCall(NativeInstance->SetDictionary(new UIntPtr((ulong) index),
				value != null ? value.GetNativeInstance() : null) != 0);
		}
		...
		///  reference will be invalidated.
		/// </summary>
		public virtual bool SetList(long index, CefListValue value)
		{
			return SafeCall(NativeInstance->SetList(new UIntPtr((ulong) index),
				value != null ? value.GetNativeInstance() : null) != 0);
		}
