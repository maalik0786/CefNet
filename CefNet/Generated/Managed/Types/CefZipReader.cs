...
namespace CefNet
{
	...
	public unsafe partial class CefZipReader : CefBaseRefCounted<cef_zip_reader_t>
	{
		...
		/// </summary>
		public virtual long FileSize => SafeCall(NativeInstance->GetFileSize());

		/// <summary>
		///  Gets the last modified timestamp for the file.
		/// </summary>
		public virtual CefTime FileLastModified => SafeCall(NativeInstance->GetFileLastModified());

		internal static CefZipReader Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual bool MoveToFirstFile()
		{
		...
		///  cursor position was set successfully.
		/// </summary>
		public virtual bool MoveToNextFile()
		{
		...
		///  cursor position was set successfully.
		/// </summary>
		public virtual bool MoveToFile(string fileName, bool caseSensitive)
		{
		...
		/// </summary>
		public virtual int OpenFile(string password)
		{
		...
		/// </summary>
		public virtual int ReadFile(IntPtr buffer, long bufferSize)
		{
