...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefRenderProcessHandler : CefBaseRefCounted<cef_render_process_handler_t>,
		ICefRenderProcessHandlerPrivate
	{
		...
		internal static CefRenderProcessHandler Create(IntPtr instance)
		{
		...
		private static void OnWebKitInitializedImpl(cef_render_process_handler_t* self)
		{
		...
		private static void OnBrowserCreatedImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_dictionary_value_t* extra_info)
		{
			...
			instance.OnBrowserCreated(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefDictionaryValue.Wrap(CefDictionaryValue.Create, extra_info));
		}
		...
		private static void OnBrowserDestroyedImpl(cef_render_process_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefRenderProcessHandler;
		...
		private static cef_load_handler_t* GetLoadHandlerImpl(cef_render_process_handler_t* self)
		{
			var instance = GetInstance((IntPtr) self) as CefRenderProcessHandler;
		...
		private static void OnContextCreatedImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context)
		{
			...
			instance.OnContextCreated(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefV8Context.Wrap(CefV8Context.Create, context));
		}
		...
		// void (*)(_cef_render_process_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame, _cef_v8context_t* context)*
		private static void OnContextReleasedImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context)
		{
			var instance = GetInstance((IntPtr) self) as CefRenderProcessHandler;
			...
			instance.OnContextReleased(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefV8Context.Wrap(CefV8Context.Create, context));
		}
		...
		/// </summary>
		protected internal virtual void OnUncaughtException(CefBrowser browser, CefFrame frame, CefV8Context context,
		...
		private static void OnUncaughtExceptionImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context, cef_v8exception_t* exception, cef_v8stack_trace_t* stackTrace)
		{
			var instance = GetInstance((IntPtr) self) as CefRenderProcessHandler;
			...
			instance.OnUncaughtException(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefV8Context.Wrap(CefV8Context.Create, context),
				CefV8Exception.Wrap(CefV8Exception.Create, exception),
				CefV8StackTrace.Wrap(CefV8StackTrace.Create, stackTrace));
		}
		...
		private static void OnFocusedNodeChangedImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_domnode_t* node)
		{
			...
			instance.OnFocusedNodeChanged(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefDOMNode.Wrap(CefDOMNode.Create, node));
		}
		...
		private static int OnProcessMessageReceivedImpl(cef_render_process_handler_t* self, cef_browser_t* browser,
		...
		private delegate void OnWebKitInitializedDelegate(cef_render_process_handler_t* self);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnBrowserCreatedDelegate(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_dictionary_value_t* extra_info);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnBrowserDestroyedDelegate(cef_render_process_handler_t* self, cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate cef_load_handler_t* GetLoadHandlerDelegate(cef_render_process_handler_t* self);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnContextCreatedDelegate(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnContextReleasedDelegate(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnUncaughtExceptionDelegate(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_v8context_t* context, cef_v8exception_t* exception,
			cef_v8stack_trace_t* stackTrace);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnFocusedNodeChangedDelegate(cef_render_process_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_domnode_t* node);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnProcessMessageReceivedDelegate(cef_render_process_handler_t* self,
