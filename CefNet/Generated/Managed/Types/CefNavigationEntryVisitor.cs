...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefNavigationEntryVisitor : CefBaseRefCounted<cef_navigation_entry_visitor_t>,
		ICefNavigationEntryVisitorPrivate
	{
		...
		internal static CefNavigationEntryVisitor Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool Visit(CefNavigationEntry entry, bool current, int index, int total)
		{
			return default;
		}

		// int (*)(_cef_navigation_entry_visitor_t* self, _cef_navigation_entry_t* entry, int current, int index, int total)*
		private static int VisitImpl(cef_navigation_entry_visitor_t* self, cef_navigation_entry_t* entry, int current,
			int index, int total)
		{
			...
			return instance.Visit(CefNavigationEntry.Wrap(CefNavigationEntry.Create, entry), current != 0, index, total)
				? 1
				: 0;
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int VisitDelegate(cef_navigation_entry_visitor_t* self, cef_navigation_entry_t* entry,
