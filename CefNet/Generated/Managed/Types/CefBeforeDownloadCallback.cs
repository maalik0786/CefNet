...
namespace CefNet
{
	...
	///  Role: Proxy
	/// </remarks>
	public unsafe class CefBeforeDownloadCallback : CefBaseRefCounted<cef_before_download_callback_t>
	{
		...
		internal static CefBeforeDownloadCallback Create(IntPtr instance)
		{
