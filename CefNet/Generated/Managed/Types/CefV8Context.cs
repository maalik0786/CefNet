...
namespace CefNet
{
	...
	public unsafe partial class CefV8Context : CefBaseRefCounted<cef_v8context_t>
	{
		...
		///  reference for WebWorker contexts.
		/// </summary>
		public virtual CefFrame Frame => SafeCall(CefFrame.Wrap(CefFrame.Create, NativeInstance->GetFrame()));

		internal static CefV8Context Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual CefV8Value GetGlobal()
		{
		...
		///  object.
		/// </summary>
		public virtual bool IsSame(CefV8Context that)
		{
		...
		/// </summary>
		public virtual bool Eval(string code, string scriptUrl, int startLine, ref CefV8Value retval,
			ref CefV8Exception exception)
		{
			fixed (char* s0 = code)
			fixed (char* s1 = scriptUrl)
			{
				...
				var p3 = retval != null ? retval.GetNativeInstance() : null;
				var pp3 = &p3;
				var p4 = exception != null ? exception.GetNativeInstance() : null;
				var pp4 = &p4;
