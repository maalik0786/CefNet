...
namespace CefNet
{
	...
	public unsafe partial class CefResourceBundle : CefBaseRefCounted<cef_resource_bundle_t>
	{
		...
		internal static CefResourceBundle Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual string GetLocalizedString(int stringId)
		{
		...
		/// </summary>
		public virtual CefBinaryValue GetDataResource(int resourceId)
		{
		...
		///  cef_pack_resources.h for a listing of valid resource ID values.
		/// </summary>
		public virtual CefBinaryValue GetDataResourceForScale(int resourceId, CefScaleFactor scaleFactor)
		{
			return SafeCall(CefBinaryValue.Wrap(CefBinaryValue.Create,
				NativeInstance->GetDataResourceForScale(resourceId, scaleFactor)));
		}
	}
}