...
namespace CefNet
{
	...
	public unsafe partial class CefPostData : CefBaseRefCounted<cef_post_data_t>
	{
		...
		/// </summary>
		public virtual bool HasExcludedElements => SafeCall(NativeInstance->HasExcludedElements() != 0);

		/// <summary>
		///  Gets the number of existing post data elements.
		/// </summary>
		public virtual long ElementCount => SafeCall((long) NativeInstance->GetElementCount());

		internal static CefPostData Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void GetElements(ref long elementsCount, ref CefPostDataElement[] elements)
		{
			var c1 = new UIntPtr((uint) elements.Length);
			var arr1 = (cef_post_data_element_t**) Marshal.AllocHGlobal(sizeof(cef_post_data_element_t*) *
			                                                            elements.Length);
		...
		///  succeeds.
		/// </summary>
		public virtual bool RemoveElement(CefPostDataElement element)
		{
		...
		/// </summary>
		public virtual bool AddElement(CefPostDataElement element)
		{
