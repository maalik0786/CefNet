...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefRequestHandler : CefBaseRefCounted<cef_request_handler_t>, ICefRequestHandlerPrivate
	{
		...
		private static readonly GetResourceRequestHandlerDelegate fnGetResourceRequestHandler =
			GetResourceRequestHandlerImpl;
		...
		private static readonly OnSelectClientCertificateDelegate fnOnSelectClientCertificate =
			OnSelectClientCertificateImpl;
		...
		private static readonly OnRenderProcessTerminatedDelegate fnOnRenderProcessTerminated =
			OnRenderProcessTerminatedImpl;

		private static readonly OnDocumentAvailableInMainFrameDelegate fnOnDocumentAvailableInMainFrame =
			OnDocumentAvailableInMainFrameImpl;
		...
		public CefRequestHandler()
		{
			...
			self->get_resource_request_handler =
				(void*) Marshal.GetFunctionPointerForDelegate(fnGetResourceRequestHandler);
			...
			self->on_render_process_terminated =
				(void*) Marshal.GetFunctionPointerForDelegate(fnOnRenderProcessTerminated);
			self->on_document_available_in_main_frame =
				(void*) Marshal.GetFunctionPointerForDelegate(fnOnDocumentAvailableInMainFrame);
		}
		...
		internal static CefRequestHandler Create(IntPtr instance)
		{
		...
		private static int OnBeforeBrowseImpl(cef_request_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
			cef_request_t* request, int user_gesture, int is_redirect)
		{
			...
			return instance.OnBeforeBrowse(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefRequest.Wrap(CefRequest.Create, request), user_gesture != 0,
				is_redirect != 0)
				? 1
				: 0;
		}
		...
		private static int OnOpenUrlFromTabImpl(cef_request_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
			cef_string_t* target_url, CefWindowOpenDisposition target_disposition, int user_gesture)
		{
			...
			return instance.OnOpenUrlFromTab(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefString.Read(target_url), target_disposition,
				user_gesture != 0)
				? 1
				: 0;
		}
		...
		private static cef_resource_request_handler_t* GetResourceRequestHandlerImpl(cef_request_handler_t* self,
			...
			cef_string_t* request_initiator, int* disable_default_handling)
		{
			...
			var rv = instance.GetResourceRequestHandler(CefBrowser.Wrap(CefBrowser.Create, browser),
				CefFrame.Wrap(CefFrame.Create, frame), CefRequest.Wrap(CefRequest.Create, request), is_navigation != 0,
				is_download != 0, CefString.Read(request_initiator), ref *disable_default_handling);
			if (rv == null)
				return null;
		...
		private static int GetAuthCredentialsImpl(cef_request_handler_t* self, cef_browser_t* browser,
			...
			cef_string_t* scheme, cef_auth_callback_t* callback)
		{
			...
			return instance.GetAuthCredentials(CefBrowser.Wrap(CefBrowser.Create, browser), CefString.Read(origin_url),
				isProxy != 0, CefString.Read(host), port, CefString.Read(realm), CefString.Read(scheme),
				CefAuthCallback.Wrap(CefAuthCallback.Create, callback))
				? 1
				: 0;
		}
		...
		private static int OnQuotaRequestImpl(cef_request_handler_t* self, cef_browser_t* browser,
			cef_string_t* origin_url, long new_size, cef_request_callback_t* callback)
		{
			var instance = GetInstance((IntPtr) self) as CefRequestHandler;
			...
			return instance.OnQuotaRequest(CefBrowser.Wrap(CefBrowser.Create, browser), CefString.Read(origin_url),
				new_size, CefRequestCallback.Wrap(CefRequestCallback.Create, callback))
				? 1
				: 0;
		}
		...
		private static int OnCertificateErrorImpl(cef_request_handler_t* self, cef_browser_t* browser,
			CefErrorCode cert_error, cef_string_t* request_url, cef_sslinfo_t* ssl_info,
			cef_request_callback_t* callback)
		{
			...
			return instance.OnCertificateError(CefBrowser.Wrap(CefBrowser.Create, browser), cert_error,
				CefString.Read(request_url), CefSSLInfo.Wrap(CefSSLInfo.Create, ssl_info),
		...
		private static int OnSelectClientCertificateImpl(cef_request_handler_t* self, cef_browser_t* browser,
			...
			cef_select_client_certificate_callback_t* callback)
		{
			...
			var obj_certificates = new CefX509Certificate[(int) certificatesCount];
			for (var i = 0; i < obj_certificates.Length; i++)
			{
			...
			return instance.OnSelectClientCertificate(CefBrowser.Wrap(CefBrowser.Create, browser), isProxy != 0,
				CefString.Read(host), port, obj_certificates,
				CefSelectClientCertificateCallback.Wrap(CefSelectClientCertificateCallback.Create, callback))
				? 1
				: 0;
		}
		...
		private static void OnPluginCrashedImpl(cef_request_handler_t* self, cef_browser_t* browser,
			cef_string_t* plugin_path)
		{
			var instance = GetInstance((IntPtr) self) as CefRequestHandler;
		...
		private static void OnRenderViewReadyImpl(cef_request_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefRequestHandler;
		...
		private static void OnRenderProcessTerminatedImpl(cef_request_handler_t* self, cef_browser_t* browser,
		...
		// void (*)(_cef_request_handler_t* self, _cef_browser_t* browser)*
		private static void OnDocumentAvailableInMainFrameImpl(cef_request_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefRequestHandler;
		...
		private delegate int OnBeforeBrowseDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_request_t* request, int user_gesture, int is_redirect);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnOpenUrlFromTabDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			cef_frame_t* frame, cef_string_t* target_url, CefWindowOpenDisposition target_disposition,
			int user_gesture);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate cef_resource_request_handler_t* GetResourceRequestHandlerDelegate(cef_request_handler_t* self,
			cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request, int is_navigation, int is_download,
			cef_string_t* request_initiator, int* disable_default_handling);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetAuthCredentialsDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			cef_string_t* origin_url, int isProxy, cef_string_t* host, int port, cef_string_t* realm,
			cef_string_t* scheme, cef_auth_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnQuotaRequestDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			cef_string_t* origin_url, long new_size, cef_request_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnCertificateErrorDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			CefErrorCode cert_error, cef_string_t* request_url, cef_sslinfo_t* ssl_info,
			cef_request_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int OnSelectClientCertificateDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			int isProxy, cef_string_t* host, int port, UIntPtr certificatesCount, cef_x509certificate_t** certificates,
			cef_select_client_certificate_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnPluginCrashedDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			cef_string_t* plugin_path);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnRenderViewReadyDelegate(cef_request_handler_t* self, cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnRenderProcessTerminatedDelegate(cef_request_handler_t* self, cef_browser_t* browser,
			CefTerminationStatus status);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnDocumentAvailableInMainFrameDelegate(cef_request_handler_t* self,
