...
namespace CefNet
{
	...
	public unsafe partial class CefFrame : CefBaseRefCounted<cef_frame_t>
	{
		...
		/// </summary>
		public virtual bool IsMain => SafeCall(NativeInstance->IsMain() != 0);

		/// <summary>
		///  Gets a value indicating whether this is the focused frame.
		/// </summary>
		public virtual bool IsFocused => SafeCall(NativeInstance->IsFocused() != 0);
		...
		/// </summary>
		public virtual long Identifier => SafeCall(NativeInstance->GetIdentifier());

		/// <summary>
		///  Gets the parent of this frame or NULL if this is the main (top-level)
		///  frame.
		/// </summary>
		public virtual CefFrame Parent => SafeCall(Wrap(Create, NativeInstance->GetParent()));
		...
		/// </summary>
		public virtual CefV8Context V8Context =>
			SafeCall(CefV8Context.Wrap(CefV8Context.Create, NativeInstance->GetV8Context()));

		internal static CefFrame Create(IntPtr instance)
		{
		...
		///  visitor.
		/// </summary>
		public virtual void GetSource(CefStringVisitor visitor)
		{
		...
		///  visitor.
		/// </summary>
		public virtual void GetText(CefStringVisitor visitor)
		{
		...
		/// </summary>
		public virtual void LoadRequest(CefRequest request)
		{
		...
		///  reporting.
		/// </summary>
		public virtual void ExecuteJavaScript(string code, string scriptUrl, int startLine)
		{
			fixed (char* s0 = code)
		...
		///  process.
		/// </summary>
		public virtual void VisitDOM(CefDOMVisitor visitor)
		{
		...
		///  function.
		/// </summary>
		public virtual CefUrlRequest CreateUrlRequest(CefRequest request, CefUrlRequestClient client)
		{
			return SafeCall(CefUrlRequest.Wrap(CefUrlRequest.Create,
				NativeInstance->CreateUrlRequest(request != null ? request.GetNativeInstance() : null,
		...
		/// </summary>
		public virtual void SendProcessMessage(CefProcessId targetProcess, CefProcessMessage message)
		{
