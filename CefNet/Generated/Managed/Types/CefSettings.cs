...
namespace CefNet
{
	...
	///  Role: Proxy
	/// </remarks>
	public unsafe class CefSettings : IDisposable
	{
		...
		{
			_disposable = true;
			NativeInstance = (cef_settings_t*) CefStructure.Allocate(sizeof(cef_settings_t));
			NativeInstance->size = new UIntPtr((uint) sizeof(cef_settings_t));
		}
		...
		public cef_settings_t* NativeInstance { get; private set; }
		...
		{
			get => NativeInstance->no_sandbox != 0;
			set => NativeInstance->no_sandbox = value ? 1 : 0;
		}
		...
		{
			get => CefString.Read(&NativeInstance->browser_subprocess_path);
			set => CefString.Replace(&NativeInstance->browser_subprocess_path, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->framework_dir_path);
			set => CefString.Replace(&NativeInstance->framework_dir_path, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->main_bundle_path);
			set => CefString.Replace(&NativeInstance->main_bundle_path, value);
		}
		...
		{
			get => NativeInstance->chrome_runtime != 0;
			set => NativeInstance->chrome_runtime = value ? 1 : 0;
		}
		...
		{
			get => NativeInstance->multi_threaded_message_loop != 0;
			set => NativeInstance->multi_threaded_message_loop = value ? 1 : 0;
		}
		...
		{
			get => NativeInstance->external_message_pump != 0;
			set => NativeInstance->external_message_pump = value ? 1 : 0;
		}
		...
		{
			get => NativeInstance->windowless_rendering_enabled != 0;
			set => NativeInstance->windowless_rendering_enabled = value ? 1 : 0;
		}
		...
		{
			get => NativeInstance->command_line_args_disabled != 0;
			set => NativeInstance->command_line_args_disabled = value ? 1 : 0;
		}
		...
		{
			get => CefString.Read(&NativeInstance->root_cache_path);
			set => CefString.Replace(&NativeInstance->root_cache_path, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->user_data_path);
			set => CefString.Replace(&NativeInstance->user_data_path, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->user_agent);
			set => CefString.Replace(&NativeInstance->user_agent, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->product_version);
			set => CefString.Replace(&NativeInstance->product_version, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->locale);
			set => CefString.Replace(&NativeInstance->locale, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->log_file);
			set => CefString.Replace(&NativeInstance->log_file, value);
		}
		...
		{
			get => NativeInstance->log_severity;
			set => NativeInstance->log_severity = value;
		}
		...
		{
			get => CefString.Read(&NativeInstance->javascript_flags);
			set => CefString.Replace(&NativeInstance->javascript_flags, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->resources_dir_path);
			set => CefString.Replace(&NativeInstance->resources_dir_path, value);
		}
		...
		{
			get => CefString.Read(&NativeInstance->locales_dir_path);
			set => CefString.Replace(&NativeInstance->locales_dir_path, value);
		}
		...
		{
			get => NativeInstance->pack_loading_disabled != 0;
			set => NativeInstance->pack_loading_disabled = value ? 1 : 0;
		}
		...
		{
			get => NativeInstance->remote_debugging_port;
			set => NativeInstance->remote_debugging_port = value;
		}
		...
		{
			get => NativeInstance->uncaught_exception_stack_size;
			set => NativeInstance->uncaught_exception_stack_size = value;
		}
		...
		{
			get => CefString.Read(&NativeInstance->application_client_id_for_file_scanning);
			set => CefString.Replace(&NativeInstance->application_client_id_for_file_scanning, value);
		}
		...
		internal static CefSettings Create(IntPtr instance)
		{
