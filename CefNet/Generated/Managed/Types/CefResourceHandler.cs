...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefResourceHandler : CefBaseRefCounted<cef_resource_handler_t>, ICefResourceHandlerPrivate
	{
		...
		internal static CefResourceHandler Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool Open(CefRequest request, ref int handleRequest, CefCallback callback)
		{
			return default;
		}

		// int (*)(_cef_resource_handler_t* self, _cef_request_t* request, int* handle_request, _cef_callback_t* callback)*
		private static int OpenImpl(cef_resource_handler_t* self, cef_request_t* request, int* handle_request,
			cef_callback_t* callback)
		{
			...
			return instance.Open(CefRequest.Wrap(CefRequest.Create, request), ref *handle_request,
		...
		/// </summary>
		protected internal virtual bool ProcessRequest(CefRequest request, CefCallback callback)
		{
			return default;
		}

		// int (*)(_cef_resource_handler_t* self, _cef_request_t* request, _cef_callback_t* callback)*
		private static int ProcessRequestImpl(cef_resource_handler_t* self, cef_request_t* request,
			cef_callback_t* callback)
		{
			var instance = GetInstance((IntPtr) self) as CefResourceHandler;
			...
			return instance.ProcessRequest(CefRequest.Wrap(CefRequest.Create, request),
				CefCallback.Wrap(CefCallback.Create, callback))
				? 1
				: 0;
		}
		...
		/// </summary>
		protected internal virtual void GetResponseHeaders(CefResponse response, ref long responseLength,
		...
		private static void GetResponseHeadersImpl(cef_resource_handler_t* self, cef_response_t* response,
			long* response_length, cef_string_t* redirectUrl)
		{
			var instance = GetInstance((IntPtr) self) as CefResourceHandler;
			...
			var s_redirectUrl = CefString.Read(redirectUrl);
			var s_orig_redirectUrl = s_redirectUrl;
			instance.GetResponseHeaders(CefResponse.Wrap(CefResponse.Create, response), ref *response_length,
				ref s_redirectUrl);
		}
		...
		/// </summary>
		protected internal virtual bool Skip(long bytesToSkip, ref long bytesSkipped, CefResourceSkipCallback callback)
		{
			return default;
		}

		// int (*)(_cef_resource_handler_t* self, int64 bytes_to_skip, int64* bytes_skipped, _cef_resource_skip_callback_t* callback)*
		private static int SkipImpl(cef_resource_handler_t* self, long bytes_to_skip, long* bytes_skipped,
			cef_resource_skip_callback_t* callback)
		{
			...
			return instance.Skip(bytes_to_skip, ref *bytes_skipped,
				CefResourceSkipCallback.Wrap(CefResourceSkipCallback.Create, callback))
				? 1
				: 0;
		}
		...
		///  will be called.
		/// </summary>
		protected internal virtual bool Read(IntPtr dataOut, int bytesToRead, ref int bytesRead,
		...
		private static int ReadImpl(cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read,
			cef_resource_read_callback_t* callback)
		{
			...
			return instance.Read((IntPtr) data_out, bytes_to_read, ref *bytes_read,
				CefResourceReadCallback.Wrap(CefResourceReadCallback.Create, callback))
				? 1
				: 0;
		}
		...
		/// </summary>
		protected internal virtual bool ReadResponse(IntPtr dataOut, int bytesToRead, ref int bytesRead,
		...
		private static int ReadResponseImpl(cef_resource_handler_t* self, void* data_out, int bytes_to_read,
			int* bytes_read, cef_callback_t* callback)
		{
			...
			return instance.ReadResponse((IntPtr) data_out, bytes_to_read, ref *bytes_read,
				CefCallback.Wrap(CefCallback.Create, callback))
				? 1
				: 0;
		}
		...
		private static void CancelImpl(cef_resource_handler_t* self)
		{
			var instance = GetInstance((IntPtr) self) as CefResourceHandler;
		...
		private delegate int OpenDelegate(cef_resource_handler_t* self, cef_request_t* request, int* handle_request,
			cef_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int ProcessRequestDelegate(cef_resource_handler_t* self, cef_request_t* request,
			cef_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void GetResponseHeadersDelegate(cef_resource_handler_t* self, cef_response_t* response,
			long* response_length, cef_string_t* redirectUrl);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int SkipDelegate(cef_resource_handler_t* self, long bytes_to_skip, long* bytes_skipped,
			cef_resource_skip_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int ReadDelegate(cef_resource_handler_t* self, void* data_out, int bytes_to_read,
			int* bytes_read, cef_resource_read_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int ReadResponseDelegate(cef_resource_handler_t* self, void* data_out, int bytes_to_read,
			int* bytes_read, cef_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void CancelDelegate(cef_resource_handler_t* self);
	}
}