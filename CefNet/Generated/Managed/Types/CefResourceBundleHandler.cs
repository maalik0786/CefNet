...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefResourceBundleHandler : CefBaseRefCounted<cef_resource_bundle_handler_t>,
		ICefResourceBundleHandlerPrivate
	{
		...
		public CefResourceBundleHandler()
		{
			...
			self->get_data_resource_for_scale =
				(void*) Marshal.GetFunctionPointerForDelegate(fnGetDataResourceForScale);
		}
		...
		internal static CefResourceBundleHandler Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool GetLocalizedString(int stringId, ref string @string)
		{
			return default;
		}

		// int (*)(_cef_resource_bundle_handler_t* self, int string_id, cef_string_t* string)*
		private static int GetLocalizedStringImpl(cef_resource_bundle_handler_t* self, int string_id,
			cef_string_t* @string)
		{
			...
			if (instance == null || ((ICefResourceBundleHandlerPrivate) instance).AvoidGetLocalizedString())
				return default;
			var s_string = CefString.Read(@string);
			var s_orig_string = s_string;
			var rv = instance.GetLocalizedString(string_id, ref s_string) ? 1 : 0;
		...
		///  resource ID values.
		/// </summary>
		protected internal virtual bool GetDataResource(int resourceId, ref IntPtr data, ref long dataSize)
		{
			return default;
		}

		// int (*)(_cef_resource_bundle_handler_t* self, int resource_id, void** data, size_t* data_size)*
		private static int GetDataResourceImpl(cef_resource_bundle_handler_t* self, int resource_id, void** data,
			UIntPtr* data_size)
		{
			var instance = GetInstance((IntPtr) self) as CefResourceBundleHandler;
			if (instance == null || ((ICefResourceBundleHandlerPrivate) instance).AvoidGetDataResource())
				return default;
			var c3 = (long) *data_size;
			var rv = instance.GetDataResource(resource_id, ref *(IntPtr*) data, ref c3) ? 1 : 0;
		...
		/// </summary>
		protected internal virtual bool GetDataResourceForScale(int resourceId, CefScaleFactor scaleFactor,
			ref IntPtr data, ref long dataSize)
		{
			return default;
		}

		// int (*)(_cef_resource_bundle_handler_t* self, int resource_id, cef_scale_factor_t scale_factor, void** data, size_t* data_size)*
		private static int GetDataResourceForScaleImpl(cef_resource_bundle_handler_t* self, int resource_id,
			CefScaleFactor scale_factor, void** data, UIntPtr* data_size)
		{
			...
			if (instance == null || ((ICefResourceBundleHandlerPrivate) instance).AvoidGetDataResourceForScale())
				return default;
			var c4 = (long) *data_size;
			var rv = instance.GetDataResourceForScale(resource_id, scale_factor, ref *(IntPtr*) data, ref c4) ? 1 : 0;
			*data_size = new UIntPtr((ulong) c4);
			return rv;
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetLocalizedStringDelegate(cef_resource_bundle_handler_t* self, int string_id,
			cef_string_t* @string);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetDataResourceDelegate(cef_resource_bundle_handler_t* self, int resource_id, void** data,
			UIntPtr* data_size);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetDataResourceForScaleDelegate(cef_resource_bundle_handler_t* self, int resource_id,
			CefScaleFactor scale_factor, void** data, UIntPtr* data_size);
	}
}