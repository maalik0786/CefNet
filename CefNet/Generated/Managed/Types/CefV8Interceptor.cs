...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefV8Interceptor : CefBaseRefCounted<cef_v8interceptor_t>, ICefV8InterceptorPrivate
	{
		...
		internal static CefV8Interceptor Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual bool GetByName(string name, CefV8Value @object, ref CefV8Value retval,
		...
		private static int GetByNameImpl(cef_v8interceptor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception)
		{
			...
			var obj_retval = CefV8Value.Wrap(CefV8Value.Create, *retval);
			var s_exception = CefString.Read(exception);
			var s_orig_exception = s_exception;
			var rv = instance.GetByName(CefString.Read(name), CefV8Value.Wrap(CefV8Value.Create, @object),
				ref obj_retval, ref s_exception)
				? 1
				: 0;
		...
		/// </summary>
		protected internal virtual bool GetByIndex(int index, CefV8Value @object, ref CefV8Value retval,
			ref string exception)
		{
			return default;
		}
		...
		private static int GetByIndexImpl(cef_v8interceptor_t* self, int index, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception)
		{
			var instance = GetInstance((IntPtr) self) as CefV8Interceptor;
			...
			var s_exception = CefString.Read(exception);
			var s_orig_exception = s_exception;
			var rv = instance.GetByIndex(index, CefV8Value.Wrap(CefV8Value.Create, @object), ref obj_retval,
				ref s_exception)
				? 1
				: 0;
			*retval = obj_retval != null ? obj_retval.GetNativeInstance() : null;
		...
		/// </summary>
		protected internal virtual bool SetByName(string name, CefV8Value @object, CefV8Value value,
			ref string exception)
		{
			return default;
		}
		...
		private static int SetByNameImpl(cef_v8interceptor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception)
		{
			...
			var s_exception = CefString.Read(exception);
			var s_orig_exception = s_exception;
			var rv = instance.SetByName(CefString.Read(name), CefV8Value.Wrap(CefV8Value.Create, @object),
				CefV8Value.Wrap(CefV8Value.Create, value), ref s_exception)
				? 1
				: 0;
			if (s_exception != s_orig_exception)
				CefString.Replace(exception, s_exception);
		...
		/// </summary>
		protected internal virtual bool SetByIndex(int index, CefV8Value @object, CefV8Value value,
			ref string exception)
		{
			return default;
		}
		...
		private static int SetByIndexImpl(cef_v8interceptor_t* self, int index, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception)
		{
			var instance = GetInstance((IntPtr) self) as CefV8Interceptor;
			...
			var s_exception = CefString.Read(exception);
			var s_orig_exception = s_exception;
			var rv = instance.SetByIndex(index, CefV8Value.Wrap(CefV8Value.Create, @object),
				CefV8Value.Wrap(CefV8Value.Create, value), ref s_exception)
				? 1
				: 0;
			if (s_exception != s_orig_exception)
		...
		private delegate int GetByNameDelegate(cef_v8interceptor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int GetByIndexDelegate(cef_v8interceptor_t* self, int index, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int SetByNameDelegate(cef_v8interceptor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int SetByIndexDelegate(cef_v8interceptor_t* self, int index, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception);
	}
}