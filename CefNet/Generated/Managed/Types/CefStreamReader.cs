...
namespace CefNet
{
	...
	public unsafe partial class CefStreamReader : CefBaseRefCounted<cef_stream_reader_t>
	{
		...
		internal static CefStreamReader Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual long Read(IntPtr ptr, long size, long n)
		{
			return SafeCall((long) NativeInstance->Read((void*) ptr, new UIntPtr((ulong) size),
				new UIntPtr((ulong) n)));
		}
