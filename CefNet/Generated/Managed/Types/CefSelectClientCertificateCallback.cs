...
namespace CefNet
{
	...
	///  Role: Proxy
	/// </remarks>
	public unsafe class CefSelectClientCertificateCallback : CefBaseRefCounted<cef_select_client_certificate_callback_t>
	{
		...
		internal static CefSelectClientCertificateCallback Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void Select(CefX509Certificate cert)
		{
