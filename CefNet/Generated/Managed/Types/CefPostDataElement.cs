...
namespace CefNet
{
	...
	public unsafe partial class CefPostDataElement : CefBaseRefCounted<cef_post_data_element_t>
	{
		...
		/// </summary>
		public virtual CefPostDataElementType Type => SafeCall(NativeInstance->GetCefType());

		/// <summary>
		///  Return the file name.
		///  The resulting string must be freed by calling cef_string_userfree_free().
		/// </summary>
		public virtual string File => SafeCall(CefString.ReadAndFree(NativeInstance->GetFile()));

		/// <summary>
		///  Return the number of bytes.
		/// </summary>
		public virtual long BytesCount => SafeCall((long) NativeInstance->GetBytesCount());

		internal static CefPostDataElement Create(IntPtr instance)
		{
		...
		///  copied.
		/// </summary>
		public virtual void SetToBytes(long size, IntPtr bytes)
		{
		...
		///  actually read.
		/// </summary>
		public virtual long GetBytes(long size, IntPtr bytes)
		{
		...
		/// </summary>
		public virtual void SetToFile(string fileName)
		{
