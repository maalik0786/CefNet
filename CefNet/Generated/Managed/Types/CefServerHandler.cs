...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefServerHandler : CefBaseRefCounted<cef_server_handler_t>, ICefServerHandlerPrivate
	{
		...
		internal static CefServerHandler Create(IntPtr instance)
		{
		...
		/// </summary>
		protected internal virtual void OnServerCreated(CefServer server)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server)*
		private static void OnServerCreatedImpl(cef_server_handler_t* self, cef_server_t* server)
		{
		...
		/// </summary>
		protected internal virtual void OnServerDestroyed(CefServer server)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server)*
		private static void OnServerDestroyedImpl(cef_server_handler_t* self, cef_server_t* server)
		{
			var instance = GetInstance((IntPtr) self) as CefServerHandler;
		...
		/// </summary>
		protected internal virtual void OnClientConnected(CefServer server, int connectionId)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id)*
		private static void OnClientConnectedImpl(cef_server_handler_t* self, cef_server_t* server, int connection_id)
		{
			var instance = GetInstance((IntPtr) self) as CefServerHandler;
		...
		///  function is called.
		/// </summary>
		protected internal virtual void OnClientDisconnected(CefServer server, int connectionId)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id)*
		private static void OnClientDisconnectedImpl(cef_server_handler_t* self, cef_server_t* server,
			int connection_id)
		{
			var instance = GetInstance((IntPtr) self) as CefServerHandler;
		...
		/// </summary>
		protected internal virtual void OnHttpRequest(CefServer server, int connectionId, string clientAddress,
			CefRequest request)
		{
		}
		...
		private static void OnHttpRequestImpl(cef_server_handler_t* self, cef_server_t* server, int connection_id,
			cef_string_t* client_address, cef_request_t* request)
		{
			...
			instance.OnHttpRequest(CefServer.Wrap(CefServer.Create, server), connection_id,
				CefString.Read(client_address), CefRequest.Wrap(CefRequest.Create, request));
		}
		...
		///  messages.
		/// </summary>
		protected internal virtual void OnWebSocketRequest(CefServer server, int connectionId, string clientAddress,
		...
		private static void OnWebSocketRequestImpl(cef_server_handler_t* self, cef_server_t* server, int connection_id,
			cef_string_t* client_address, cef_request_t* request, cef_callback_t* callback)
		{
			...
			instance.OnWebSocketRequest(CefServer.Wrap(CefServer.Create, server), connection_id,
				CefString.Read(client_address), CefRequest.Wrap(CefRequest.Create, request),
				CefCallback.Wrap(CefCallback.Create, callback));
		}
		...
		/// </summary>
		protected internal virtual void OnWebSocketConnected(CefServer server, int connectionId)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id)*
		private static void OnWebSocketConnectedImpl(cef_server_handler_t* self, cef_server_t* server,
			int connection_id)
		{
			var instance = GetInstance((IntPtr) self) as CefServerHandler;
		...
		///  intended usage.
		/// </summary>
		protected internal virtual void OnWebSocketMessage(CefServer server, int connectionId, IntPtr data,
			long dataSize)
		{
		}

		// void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id, const void* data, size_t data_size)*
		private static void OnWebSocketMessageImpl(cef_server_handler_t* self, cef_server_t* server, int connection_id,
			void* data, UIntPtr data_size)
		{
			var instance = GetInstance((IntPtr) self) as CefServerHandler;
			...
			instance.OnWebSocketMessage(CefServer.Wrap(CefServer.Create, server), connection_id, (IntPtr) data,
				(long) data_size);
		}

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnServerCreatedDelegate(cef_server_handler_t* self, cef_server_t* server);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnServerDestroyedDelegate(cef_server_handler_t* self, cef_server_t* server);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnClientConnectedDelegate(cef_server_handler_t* self, cef_server_t* server,
			int connection_id);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnClientDisconnectedDelegate(cef_server_handler_t* self, cef_server_t* server,
			int connection_id);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnHttpRequestDelegate(cef_server_handler_t* self, cef_server_t* server, int connection_id,
			cef_string_t* client_address, cef_request_t* request);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnWebSocketRequestDelegate(cef_server_handler_t* self, cef_server_t* server,
			int connection_id, cef_string_t* client_address, cef_request_t* request, cef_callback_t* callback);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnWebSocketConnectedDelegate(cef_server_handler_t* self, cef_server_t* server,
			int connection_id);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnWebSocketMessageDelegate(cef_server_handler_t* self, cef_server_t* server,
			int connection_id, void* data, UIntPtr data_size);
	}
}