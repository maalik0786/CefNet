...
namespace CefNet
{
	...
	public unsafe partial class CefCookieManager : CefBaseRefCounted<cef_cookie_manager_t>
	{
		...
		internal static CefCookieManager Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual void SetSupportedSchemes(CefStringList schemes, bool includeDefaults,
			CefCompletionCallback callback)
		{
			NativeInstance->SetSupportedSchemes(schemes.GetNativeInstance(), includeDefaults ? 1 : 0,
		...
		///  cannot be accessed.
		/// </summary>
		public virtual bool VisitAllCookies(CefCookieVisitor visitor)
		{
		...
		/// </summary>
		public virtual bool VisitUrlCookies(string url, bool includeHttpOnly, CefCookieVisitor visitor)
		{
			fixed (char* s0 = url)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = url != null ? url.Length : 0};
				return SafeCall(NativeInstance->VisitUrlCookies(&cstr0, includeHttpOnly ? 1 : 0,
					visitor != null ? visitor.GetNativeInstance() : null) != 0);
			}
		}
		...
		/// </summary>
		public virtual bool SetCookie(string url, CefCookie cookie, CefSetCookieCallback callback)
		{
			fixed (char* s0 = url)
			{
				var cstr0 = new cef_string_t {Str = s0, Length = url != null ? url.Length : 0};
				return SafeCall(NativeInstance->SetCookie(&cstr0, (cef_cookie_t*) &cookie,
		...
		/// </summary>
		public virtual bool DeleteCookies(string url, string cookieName, CefDeleteCookiesCallback callback)
		{
			fixed (char* s0 = url)
			fixed (char* s1 = cookieName)
			{
				...
				return SafeCall(NativeInstance->DeleteCookies(&cstr0, &cstr1,
					callback != null ? callback.GetNativeInstance() : null) != 0);
			}
		}
		...
		///  Returns false (0) if cookies cannot be accessed.
		/// </summary>
		public virtual bool FlushStore(CefCompletionCallback callback)
		{
