...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefV8Accessor : CefBaseRefCounted<cef_v8accessor_t>, ICefV8AccessorPrivate
	{
		...
		internal static CefV8Accessor Create(IntPtr instance)
		{
		...
		///  handled.
		/// </summary>
		protected internal virtual bool Get(string name, CefV8Value @object, ref CefV8Value retval,
		...
		private static int GetImpl(cef_v8accessor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception)
		{
			...
			var rv = instance.Get(CefString.Read(name), CefV8Value.Wrap(CefV8Value.Create, @object), ref obj_retval,
				ref s_exception)
				? 1
				: 0;
		...
		///  handled.
		/// </summary>
		protected internal virtual bool Set(string name, CefV8Value @object, CefV8Value value, ref string exception)
		{
			return default;
		}

		// int (*)(_cef_v8accessor_t* self, const cef_string_t* name, _cef_v8value_t* object, _cef_v8value_t* value, cef_string_t* exception)*
		private static int SetImpl(cef_v8accessor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception)
		{
			...
			var s_exception = CefString.Read(exception);
			var s_orig_exception = s_exception;
			var rv = instance.Set(CefString.Read(name), CefV8Value.Wrap(CefV8Value.Create, @object),
		...
		private delegate int GetDelegate(cef_v8accessor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t** retval, cef_string_t* exception);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate int SetDelegate(cef_v8accessor_t* self, cef_string_t* name, cef_v8value_t* @object,
			cef_v8value_t* value, cef_string_t* exception);
	}
}