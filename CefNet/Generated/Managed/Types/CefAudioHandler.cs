...
namespace CefNet
{
	...
	///  Role: Handler
	/// </remarks>
	public unsafe class CefAudioHandler : CefBaseRefCounted<cef_audio_handler_t>, ICefAudioHandlerPrivate
	{
		...
		internal static CefAudioHandler Create(IntPtr instance)
		{
		...
		private static int GetAudioParametersImpl(cef_audio_handler_t* self, cef_browser_t* browser,
			cef_audio_parameters_t* @params)
		{
			...
			return instance.GetAudioParameters(CefBrowser.Wrap(CefBrowser.Create, browser),
				ref *(CefAudioParameters*) @params)
				? 1
				: 0;
		}
		...
		private static void OnAudioStreamStartedImpl(cef_audio_handler_t* self, cef_browser_t* browser,
			cef_audio_parameters_t* @params, int channels)
		{
			...
			instance.OnAudioStreamStarted(CefBrowser.Wrap(CefBrowser.Create, browser), *(CefAudioParameters*) @params,
				channels);
		}
		...
		private static void OnAudioStreamPacketImpl(cef_audio_handler_t* self, cef_browser_t* browser, float** data,
			int frames, long pts)
		{
			var instance = GetInstance((IntPtr) self) as CefAudioHandler;
		...
		private static void OnAudioStreamStoppedImpl(cef_audio_handler_t* self, cef_browser_t* browser)
		{
			var instance = GetInstance((IntPtr) self) as CefAudioHandler;
		...
		private static void OnAudioStreamErrorImpl(cef_audio_handler_t* self, cef_browser_t* browser,
		...
		private delegate int GetAudioParametersDelegate(cef_audio_handler_t* self, cef_browser_t* browser,
			cef_audio_parameters_t* @params);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnAudioStreamStartedDelegate(cef_audio_handler_t* self, cef_browser_t* browser,
			cef_audio_parameters_t* @params, int channels);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnAudioStreamPacketDelegate(cef_audio_handler_t* self, cef_browser_t* browser,
			float** data, int frames, long pts);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnAudioStreamStoppedDelegate(cef_audio_handler_t* self, cef_browser_t* browser);

		[UnmanagedFunctionPointer(CallingConvention.Winapi)]
		private delegate void OnAudioStreamErrorDelegate(cef_audio_handler_t* self, cef_browser_t* browser,
			cef_string_t* message);
	}
}