...
namespace CefNet
{
	...
	public unsafe partial class CefWaitableEvent : CefBaseRefCounted<cef_waitable_event_t>
	{
		...
		/// </summary>
		public virtual bool IsSignaled => SafeCall(NativeInstance->IsSignaled() != 0);

		internal static CefWaitableEvent Create(IntPtr instance)
		{
		...
		/// </summary>
		public virtual bool TimedWait(long maxMs)
		{
