...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_v8context_t
	{
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_frame_t* GetFrame();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_v8value_t* GetGlobal();
		...
		[NativeName("is_same")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int IsSame(cef_v8context_t* that);

		/// <summary>
		///  int (*)(_cef_v8context_t* self, const cef_string_t* code, const cef_string_t* script_url, int start_line,
		///  _cef_v8value_t** retval, _cef_v8exception_t** exception)*
		/// </summary>
		public void* eval;
		...
		[NativeName("eval")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int Eval([Immutable] cef_string_t* code, [Immutable] cef_string_t* script_url, int start_line,
