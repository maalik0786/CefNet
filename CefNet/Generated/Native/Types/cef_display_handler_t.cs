...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_display_handler_t
	{
		...
		public extern void OnAddressChange(cef_browser_t* browser, cef_frame_t* frame, [Immutable] cef_string_t* url);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnTitleChange(cef_browser_t* browser, [Immutable] cef_string_t* title);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnFaviconUrlChange(cef_browser_t* browser, cef_string_list_t icon_urls);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnFullscreenModeChange(cef_browser_t* browser, int fullscreen);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int OnTooltip(cef_browser_t* browser, cef_string_t* text);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnStatusMessage(cef_browser_t* browser, [Immutable] cef_string_t* value);

		/// <summary>
		///  int (*)(_cef_display_handler_t* self, _cef_browser_t* browser, cef_log_severity_t level, const cef_string_t*
		///  message, const cef_string_t* source, int line)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int OnConsoleMessage(cef_browser_t* browser, CefLogSeverity level,
			[Immutable] cef_string_t* message, [Immutable] cef_string_t* source, int line);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int OnAutoResize(cef_browser_t* browser, [Immutable] cef_size_t* new_size);
		...
		public extern void OnLoadingProgressChange(cef_browser_t* browser, double progress);
	}
}