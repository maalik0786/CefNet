...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_audio_handler_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		public extern int GetAudioParameters(cef_browser_t* browser, cef_audio_parameters_t* @params);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnAudioStreamStarted(cef_browser_t* browser, [Immutable] cef_audio_parameters_t* @params,
			int channels);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnAudioStreamPacket(cef_browser_t* browser, [Immutable] float** data, int frames, long pts);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnAudioStreamStopped(cef_browser_t* browser);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnAudioStreamError(cef_browser_t* browser, [Immutable] cef_string_t* message);
	}
}