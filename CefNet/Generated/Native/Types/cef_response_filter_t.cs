...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_response_filter_t
	{
		...
		public extern int InitFilter();

		/// <summary>
		///  cef_response_filter_status_t (*)(_cef_response_filter_t* self, void* data_in, size_t data_in_size, size_t*
		///  data_in_read, void* data_out, size_t data_out_size, size_t* data_out_written)*
		/// </summary>
		public void* filter;
		...
		[NativeName("filter")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern CefResponseFilterStatus Filter(void* data_in, UIntPtr data_in_size, UIntPtr* data_in_read,
			void* data_out, UIntPtr data_out_size, UIntPtr* data_out_written);
	}
}