...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_browser_host_t
	{
		...
		public extern cef_browser_t* GetBrowser();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void CloseBrowser(int force_close);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int TryCloseBrowser();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetFocus(int focus);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern IntPtr GetWindowHandle();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern IntPtr GetOpenerWindowHandle();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_client_t* GetClient();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_request_context_t* GetRequestContext();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern double GetZoomLevel();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetZoomLevel(double zoomLevel);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, cef_file_dialog_mode_t mode, const cef_string_t* title, const cef_string_t*
		///  default_file_path, cef_string_list_t accept_filters, int selected_accept_filter, _cef_run_file_dialog_callback_t*
		///  callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void RunFileDialog(CefFileDialogMode mode, [Immutable] cef_string_t* title,
			[Immutable] cef_string_t* default_file_path, cef_string_list_t accept_filters, int selected_accept_filter,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void StartDownload([Immutable] cef_string_t* url);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const cef_string_t* image_url, int is_favicon, uint32 max_image_size, int
		///  bypass_cache, _cef_download_image_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DownloadImage([Immutable] cef_string_t* image_url, int is_favicon, uint max_image_size,
		...
		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const cef_string_t* path, const const _cef_pdf_print_settings_t* settings,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void PrintToPdf([Immutable] cef_string_t* path, [Immutable] cef_pdf_print_settings_t* settings,
			cef_pdf_print_callback_t* callback);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, int identifier, const cef_string_t* searchText, int forward, int matchCase, int
		///  findNext)*
		/// </summary>
		public void* find;
		...
		[NativeName("find")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void Find(int identifier, [Immutable] cef_string_t* searchText, int forward, int matchCase,
			int findNext);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void StopFinding(int clearSelection);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const const _cef_window_info_t* windowInfo, _cef_client_t* client, const const
		///  _cef_browser_settings_t* settings, const cef_point_t* inspect_element_at)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ShowDevTools([Immutable] cef_window_info_t* windowInfo, cef_client_t* client,
			[Immutable] cef_browser_settings_t* settings, [Immutable] cef_point_t* inspect_element_at);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void CloseDevTools();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int SendDevToolsMessage([Immutable] void* message, UIntPtr message_size);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int ExecuteDevToolsMethod(int message_id, [Immutable] cef_string_t* method,
			cef_dictionary_value_t* @params);
		...
		public extern cef_registration_t* AddDevToolsMessageObserver(cef_dev_tools_message_observer_t* observer);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void GetNavigationEntries(cef_navigation_entry_visitor_t* visitor, int current_only);
		...
		public extern void SetMouseCursorChangeDisabled(int disabled);
		...
		public extern int IsMouseCursorChangeDisabled();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ReplaceMisspelling([Immutable] cef_string_t* word);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void AddWordToDictionary([Immutable] cef_string_t* word);
		...
		public extern int IsWindowRenderingDisabled();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void WasHidden(int hidden);
		...
		public extern void NotifyScreenInfoChanged();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void Invalidate(CefPaintElementType type);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendExternalBeginFrame();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendKeyEvent([Immutable] cef_key_event_t* @event);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const const _cef_mouse_event_t* event, cef_mouse_button_type_t type, int
		///  mouseUp, int clickCount)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendMouseClickEvent([Immutable] cef_mouse_event_t* @event, CefMouseButtonType type,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendMouseMoveEvent([Immutable] cef_mouse_event_t* @event, int mouseLeave);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendMouseWheelEvent([Immutable] cef_mouse_event_t* @event, int deltaX, int deltaY);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendTouchEvent([Immutable] cef_touch_event_t* @event);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendFocusEvent(int setFocus);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendCaptureLostEvent();
		...
		public extern void NotifyMoveOrResizeStarted();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int GetWindowlessFrameRate();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetWindowlessFrameRate(int frame_rate);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const cef_string_t* text, size_t underlinesCount, const
		///  cef_composition_underline_t* underlines, const cef_range_t* replacement_range, const cef_range_t* selection_range)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ImeSetComposition([Immutable] cef_string_t* text, UIntPtr underlinesCount,
			[Immutable] cef_composition_underline_t* underlines, [Immutable] cef_range_t* replacement_range,
			[Immutable] cef_range_t* selection_range);

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, const cef_string_t* text, const cef_range_t* replacement_range, int
		///  relative_cursor_pos)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ImeCommitText([Immutable] cef_string_t* text, [Immutable] cef_range_t* replacement_range,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ImeFinishComposingText(int keep_selection);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void ImeCancelComposition();

		/// <summary>
		///  void (*)(_cef_browser_host_t* self, _cef_drag_data_t* drag_data, const const _cef_mouse_event_t* event,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DragTargetDragEnter(cef_drag_data_t* drag_data, [Immutable] cef_mouse_event_t* @event,
			CefDragOperationsMask allowed_ops);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DragTargetDragOver([Immutable] cef_mouse_event_t* @event, CefDragOperationsMask allowed_ops);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DragTargetDragLeave();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DragTargetDrop([Immutable] cef_mouse_event_t* @event);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void DragSourceEndedAt(int x, int y, CefDragOperationsMask op);
		...
		public extern void DragSourceSystemDragEnded();
		...
		public extern cef_navigation_entry_t* GetVisibleNavigationEntry();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetAccessibilityState(CefState accessibility_state);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetAutoResizeEnabled(int enabled, [Immutable] cef_size_t* min_size,
			[Immutable] cef_size_t* max_size);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_extension_t* GetExtension();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int IsBackgroundHost();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SetAudioMuted(int mute);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int IsAudioMuted();
	}
}