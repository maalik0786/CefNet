...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_resource_handler_t
	{
		...
		public extern int Open(cef_request_t* request, int* handle_request, cef_callback_t* callback);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int ProcessRequest(cef_request_t* request, cef_callback_t* callback);

		/// <summary>
		///  void (*)(_cef_resource_handler_t* self, _cef_response_t* response, int64* response_length, cef_string_t*
		///  redirectUrl)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void GetResponseHeaders(cef_response_t* response, long* response_length,
			cef_string_t* redirectUrl);

		/// <summary>
		///  int (*)(_cef_resource_handler_t* self, int64 bytes_to_skip, int64* bytes_skipped, _cef_resource_skip_callback_t*
		///  callback)*
		/// </summary>
		public void* skip;
		...
		[NativeName("skip")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int Skip(long bytes_to_skip, long* bytes_skipped, cef_resource_skip_callback_t* callback);

		/// <summary>
		///  int (*)(_cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read,
		///  _cef_resource_read_callback_t* callback)*
		/// </summary>
		public void* read;
		...
		[NativeName("read")]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int Read(void* data_out, int bytes_to_read, int* bytes_read,
			cef_resource_read_callback_t* callback);

		/// <summary>
		///  int (*)(_cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read, _cef_callback_t*
		///  callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int ReadResponse(void* data_out, int bytes_to_read, int* bytes_read, cef_callback_t* callback);
