...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_resource_request_handler_t
	{
		...
		/// <summary>
		///  _cef_cookie_access_filter_t* (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t*
		///  frame, _cef_request_t* request)*
		/// </summary>
		...
		public extern cef_cookie_access_filter_t* GetCookieAccessFilter(cef_browser_t* browser, cef_frame_t* frame,
			cef_request_t* request);

		/// <summary>
		///  cef_return_value_t (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame,
		///  _cef_request_t* request, _cef_request_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern CefReturnValue OnBeforeResourceLoad(cef_browser_t* browser, cef_frame_t* frame,
			cef_request_t* request, cef_request_callback_t* callback);

		/// <summary>
		///  _cef_resource_handler_t* (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_resource_handler_t* GetResourceHandler(cef_browser_t* browser, cef_frame_t* frame,
			cef_request_t* request);

		/// <summary>
		///  void (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame, _cef_request_t*
		///  request, _cef_response_t* response, cef_string_t* new_url)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnResourceRedirect(cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request,
			cef_response_t* response, cef_string_t* new_url);

		/// <summary>
		///  int (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame, _cef_request_t*
		///  request, _cef_response_t* response)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int OnResourceResponse(cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request,
			cef_response_t* response);

		/// <summary>
		///  _cef_response_filter_t* (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame,
		///  _cef_request_t* request, _cef_response_t* response)*
		/// </summary>
		...
		public extern cef_response_filter_t* GetResourceResponseFilter(cef_browser_t* browser, cef_frame_t* frame,
			cef_request_t* request, cef_response_t* response);

		/// <summary>
		///  void (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame, _cef_request_t*
		///  request, _cef_response_t* response, cef_urlrequest_status_t status, int64 received_content_length)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnResourceLoadComplete(cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request,
			cef_response_t* response, CefUrlRequestStatus status, long received_content_length);

		/// <summary>
		///  void (*)(_cef_resource_request_handler_t* self, _cef_browser_t* browser, _cef_frame_t* frame, _cef_request_t*
		///  request, int* allow_os_execution)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnProtocolExecution(cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request,
