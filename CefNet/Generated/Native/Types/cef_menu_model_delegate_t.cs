...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_menu_model_delegate_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		/// <summary>
		///  void (*)(_cef_menu_model_delegate_t* self, _cef_menu_model_t* menu_model, int command_id, cef_event_flags_t
		///  event_flags)*
		/// </summary>
		...
		public extern void ExecuteCommand(cef_menu_model_t* menu_model, int command_id, CefEventFlags event_flags);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void MouseOutsideMenu(cef_menu_model_t* menu_model, [Immutable] cef_point_t* screen_point);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void UnhandledOpenSubmenu(cef_menu_model_t* menu_model, int is_rtl);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void UnhandledCloseSubmenu(cef_menu_model_t* menu_model, int is_rtl);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void MenuWillShow(cef_menu_model_t* menu_model);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void MenuClosed(cef_menu_model_t* menu_model);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int FormatLabel(cef_menu_model_t* menu_model, cef_string_t* label);
	}
}