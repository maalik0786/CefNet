...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_server_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_string_userfree_t GetAddress();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int HasConnection();
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int IsValidConnection(int connection_id);

		/// <summary>
		///  void (*)(_cef_server_t* self, int connection_id, const cef_string_t* content_type, const void* data, size_t
		///  data_size)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendHttp200response(int connection_id, [Immutable] cef_string_t* content_type,
			[Immutable] void* data, UIntPtr data_size);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendHttp404response(int connection_id);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendHttp500response(int connection_id, [Immutable] cef_string_t* error_message);

		/// <summary>
		///  void (*)(_cef_server_t* self, int connection_id, int response_code, const cef_string_t* content_type, int64
		///  content_length, cef_string_multimap_t extra_headers)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendHttpResponse(int connection_id, int response_code,
			[Immutable] cef_string_t* content_type, long content_length, cef_string_multimap_t extra_headers);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendRawData(int connection_id, [Immutable] void* data, UIntPtr data_size);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void CloseConnection(int connection_id);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void SendWebSocketMessage(int connection_id, [Immutable] void* data, UIntPtr data_size);
	}
}