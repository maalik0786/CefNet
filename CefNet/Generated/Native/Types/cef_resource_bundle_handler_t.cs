...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_resource_bundle_handler_t
	{
		...
		public extern int GetLocalizedString(int string_id, cef_string_t* @string);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int GetDataResource(int resource_id, void** data, UIntPtr* data_size);

		/// <summary>
		///  int (*)(_cef_resource_bundle_handler_t* self, int resource_id, cef_scale_factor_t scale_factor, void** data,
		///  size_t* data_size)*
		/// </summary>
		...
		public extern int GetDataResourceForScale(int resource_id, CefScaleFactor scale_factor, void** data,
			UIntPtr* data_size);
	}
}