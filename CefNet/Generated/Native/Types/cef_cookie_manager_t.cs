...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_cookie_manager_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		/// <summary>
		///  void (*)(_cef_cookie_manager_t* self, cef_string_list_t schemes, int include_defaults, _cef_completion_callback_t*
		///  callback)*
		/// </summary>
		...
		public extern void SetSupportedSchemes(cef_string_list_t schemes, int include_defaults,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int VisitAllCookies(cef_cookie_visitor_t* visitor);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int VisitUrlCookies([Immutable] cef_string_t* url, int includeHttpOnly,
			cef_cookie_visitor_t* visitor);

		/// <summary>
		///  int (*)(_cef_cookie_manager_t* self, const cef_string_t* url, const const _cef_cookie_t* cookie,
		///  _cef_set_cookie_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int SetCookie([Immutable] cef_string_t* url, [Immutable] cef_cookie_t* cookie,
			cef_set_cookie_callback_t* callback);

		/// <summary>
		///  int (*)(_cef_cookie_manager_t* self, const cef_string_t* url, const cef_string_t* cookie_name,
		///  _cef_delete_cookies_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int DeleteCookies([Immutable] cef_string_t* url, [Immutable] cef_string_t* cookie_name,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int FlushStore(cef_completion_callback_t* callback);
	}
}