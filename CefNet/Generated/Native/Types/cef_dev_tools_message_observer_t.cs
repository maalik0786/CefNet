...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_dev_tools_message_observer_t
	{
		...
		/// <summary>
		///  int (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser, const void* message, size_t
		///  message_size)*
		/// </summary>
		...
		public extern int OnDevToolsMessage(cef_browser_t* browser, [Immutable] void* message, UIntPtr message_size);

		/// <summary>
		///  void (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser, int message_id, int success, const void*
		...
		public extern void OnDevToolsMethodResult(cef_browser_t* browser, int message_id, int success,
			[Immutable] void* result, UIntPtr result_size);

		/// <summary>
		///  void (*)(_cef_dev_tools_message_observer_t* self, _cef_browser_t* browser, const cef_string_t* method, const void*
		///  params, size_t params_size)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnDevToolsEvent(cef_browser_t* browser, [Immutable] cef_string_t* method,
			[Immutable] void* @params, UIntPtr params_size);
		...
		public extern void OnDevToolsAgentAttached(cef_browser_t* browser);
		...
		public extern void OnDevToolsAgentDetached(cef_browser_t* browser);
	}
}