...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_urlrequest_client_t
	{
		...
		public extern void OnRequestComplete(cef_urlrequest_t* request);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnUploadProgress(cef_urlrequest_t* request, long current, long total);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnDownloadProgress(cef_urlrequest_t* request, long current, long total);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnDownloadData(cef_urlrequest_t* request, [Immutable] void* data, UIntPtr data_length);

		/// <summary>
		///  int (*)(_cef_urlrequest_client_t* self, int isProxy, const cef_string_t* host, int port, const cef_string_t* realm,
		///  const cef_string_t* scheme, _cef_auth_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int GetAuthCredentials(int isProxy, [Immutable] cef_string_t* host, int port,
			[Immutable] cef_string_t* realm, [Immutable] cef_string_t* scheme, cef_auth_callback_t* callback);
	}
}