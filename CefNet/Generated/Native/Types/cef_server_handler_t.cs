...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_server_handler_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		public extern void OnServerCreated(cef_server_t* server);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnServerDestroyed(cef_server_t* server);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnClientConnected(cef_server_t* server, int connection_id);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnClientDisconnected(cef_server_t* server, int connection_id);

		/// <summary>
		///  void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id, const cef_string_t* client_address,
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnHttpRequest(cef_server_t* server, int connection_id,
			[Immutable] cef_string_t* client_address, cef_request_t* request);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnWebSocketRequest(cef_server_t* server, int connection_id,
			[Immutable] cef_string_t* client_address, cef_request_t* request, cef_callback_t* callback);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnWebSocketConnected(cef_server_t* server, int connection_id);

		/// <summary>
		///  void (*)(_cef_server_handler_t* self, _cef_server_t* server, int connection_id, const void* data, size_t
		///  data_size)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnWebSocketMessage(cef_server_t* server, int connection_id, [Immutable] void* data,
			UIntPtr data_size);
	}
}