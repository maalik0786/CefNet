...
namespace CefNet.CApi
{
	...
	public unsafe struct cef_extension_handler_t
	{
		/// <summary>
		///  Base structure.
		/// </summary>
		...
		public extern void OnExtensionLoadFailed(CefErrorCode result);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnExtensionLoaded(cef_extension_t* extension);
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern void OnExtensionUnloaded(cef_extension_t* extension);

		/// <summary>
		///  int (*)(_cef_extension_handler_t* self, _cef_extension_t* extension, const cef_string_t* url, _cef_client_t**
		///  client, _cef_browser_settings_t* settings)*
		/// </summary>
		...
		public extern int OnBeforeBackgroundBrowser(cef_extension_t* extension, [Immutable] cef_string_t* url,
			cef_client_t** client, cef_browser_settings_t* settings);

		/// <summary>
		///  int (*)(_cef_extension_handler_t* self, _cef_extension_t* extension, _cef_browser_t* browser, _cef_browser_t*
		///  active_browser, int index, const cef_string_t* url, int active, _cef_window_info_t* windowInfo, _cef_client_t**
		///  client, _cef_browser_settings_t* settings)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int OnBeforeBrowser(cef_extension_t* extension, cef_browser_t* browser,
			cef_browser_t* active_browser, int index, [Immutable] cef_string_t* url, int active,
			cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings);

		/// <summary>
		///  _cef_browser_t* (*)(_cef_extension_handler_t* self, _cef_extension_t* extension, _cef_browser_t* browser, int
		///  include_incognito)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern cef_browser_t* GetActiveBrowser(cef_extension_t* extension, cef_browser_t* browser,
			int include_incognito);

		/// <summary>
		///  int (*)(_cef_extension_handler_t* self, _cef_extension_t* extension, _cef_browser_t* browser, int
		///  include_incognito, _cef_browser_t* target_browser)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int CanAccessBrowser(cef_extension_t* extension, cef_browser_t* browser, int include_incognito,
			cef_browser_t* target_browser);

		/// <summary>
		///  int (*)(_cef_extension_handler_t* self, _cef_extension_t* extension, _cef_browser_t* browser, const cef_string_t*
		///  file, _cef_get_extension_resource_callback_t* callback)*
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.ForwardRef)]
		public extern int GetExtensionResource(cef_extension_t* extension, cef_browser_t* browser,
			[Immutable] cef_string_t* file, cef_get_extension_resource_callback_t* callback);
	}
}