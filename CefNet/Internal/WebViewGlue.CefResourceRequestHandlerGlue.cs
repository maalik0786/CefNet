...
namespace CefNet.Internal
{
	public partial class WebViewGlue
	{
		...
		/// <summary>
		///  Called on the IO thread before a resource request is loaded. To redirect or change the resource load optionally
		///  modify |request|.
		...
		/// </param>
		/// <returns>
		///  Return Continue to continue the request immediately. Return ContinueAsync and call CefRequestCallback:: Continue()
		///  at a later time to continue
		...
		/// </param>
		/// <returns>
		///  To allow the resource to load using the default network loader return NULL. To specify a handler for the resource
		///  return a CefResourceHandler object.
		/// </returns>
		...
		/// </param>
		/// <param name="request">
		///  The |request| parameter will contain the old URL and other request-related information. Cannot be modified in this
		///  callback.
		/// </param>
		/// <param name="response">
		///  The |response| parameter will contain the response that resulted in the redirect. Cannot be modified in this
		///  callback.
		/// </param>
		/// <param name="newUrl">
		...
		/// <summary>
		///  Called on the IO thread when a resource response is received. Modification of the request URL will be treated as a
		///  redirect.
		///  Requests handled using the default network loader cannot be redirected in this callback. WARNING: Redirecting using
		///  this
		...
		/// <summary>
		///  Called on the IO thread when a resource load has completed. This method will be called for all requests, including
		///  requests
