...
namespace CefNet.Internal
{
	public partial class WebViewGlue
	{
		...
		protected internal virtual bool GetAudioParameters(CefBrowser browser, ref CefAudioParameters @params)
		{
			return false;
		}
		...
		/// </remarks>
		protected internal virtual void OnAudioStreamStarted(CefBrowser browser, CefAudioParameters @params,
			int channels)
		{
		}
		...
		/// </param>
		protected internal virtual void OnAudioStreamPacket(CefBrowser browser, IntPtr data, int frames, long pts)
		{
		}
		...
		/// </summary>
		/// <param name="browser">The browser.</param>
		protected internal virtual void OnAudioStreamStopped(CefBrowser browser)
		{
		}
		...
		protected internal virtual void OnAudioStreamError(CefBrowser browser, string message)
		{
		}
	}
}